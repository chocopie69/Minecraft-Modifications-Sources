...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, I18n.format("advMode.command", new Object[0]), (float)(GuiCommandBlock.width / 2 - 150), 37.0f, 10526880);
        this.commandTextField.drawTextBox();
        int i = 75;
        int j = 0;
        this.drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), (float)(GuiCommandBlock.width / 2 - 150), (float)(i + j++ * this.fontRendererObj.FONT_HEIGHT), 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), (float)(GuiCommandBlock.width / 2 - 150), (float)(i + j++ * this.fontRendererObj.FONT_HEIGHT), 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), (float)(GuiCommandBlock.width / 2 - 150), (float)(i + j++ * this.fontRendererObj.FONT_HEIGHT), 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), (float)(GuiCommandBlock.width / 2 - 150), (float)(i + j++ * this.fontRendererObj.FONT_HEIGHT), 10526880);
        this.drawString(this.fontRendererObj, "", (float)(GuiCommandBlock.width / 2 - 150), (float)(i + j++ * this.fontRendererObj.FONT_HEIGHT), 10526880);
        if (this.previousOutputTextField.getText().length() > 0) {
            i = i + j * this.fontRendererObj.FONT_HEIGHT + 16;
            this.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), (float)(GuiCommandBlock.width / 2 - 150), (float)i, 10526880);
