...
public class GuiButton extends Gui {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (visible) {
            ...
            RenderUtil.INSTANCE.drawRect(xPosition + width / 2 - Summer.INSTANCE.getFontManager().arial20.getWidth(displayString) / 2, yPosition + height - hoverAnimation, xPosition + width / 2 + Summer.INSTANCE.getFontManager().arial20.getWidth(displayString) / 2, yPosition + height - 1, -1);
            this.mouseDragged(mc, mouseX, mouseY);
            Summer.INSTANCE.getFontManager().arial20.drawCenteredString(displayString, xPosition + width / 2, yPosition + height / 2 - Summer.INSTANCE.getFontManager().arial20.getHeight(displayString) / 2, -1);
        }
    }
