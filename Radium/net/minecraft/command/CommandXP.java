    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (flag) {
            ...
            if (flag2) {
                ...
                CommandBase.notifyOperators(sender, this, "commands.xp.success.negative.levels", i, entityplayer.getCommandSenderName());
            }
            else {
                entityplayer.addExperienceLevel(i);
                CommandBase.notifyOperators(sender, this, "commands.xp.success.levels", i, entityplayer.getCommandSenderName());
            }
        }
        else {
            ...
            CommandBase.notifyOperators(sender, this, "commands.xp.success", i, entityplayer.getCommandSenderName());
        }
    }
