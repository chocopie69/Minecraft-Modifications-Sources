...
public class GuitriviaOpenLinkFailed extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRendererObj, "http://triviaclient.weebly.com/download.html", width / 2, height / 2 - 40,
				0xffffff);
