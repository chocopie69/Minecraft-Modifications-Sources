...
public class Gui {
   ...
   public static void drawGradientRect(float left, float top, float right, float bottom, int startColor, int endColor) {
      RenderingUtils.drawGradientRect((double)left, (double)top, (double)right, (double)bottom, false, startColor, endColor);
   }
   ...
   public static void drawStringWithShadow(String text, double x, double y, int color) {
      Massacre.INSTANCE.getFontManager().getLatoRegularMainMenu().drawStringWithShadow(text, (float)x, (float)y, color);
   }

   public void drawCenteredString(String text, int x, int y, int color) {
      drawStringWithShadow(text, (double)((float)x - Massacre.INSTANCE.getFontManager().getLatoRegularMainMenu().getWidth(text) / 2.0F), (double)y, color);
   }
