...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject
{
    ...
    class TeamSelectionObject implements ISpectatorMenuObject
    {
        ...
        public void func_178663_a(final float p_178663_1_, final int alpha) {
            int i = -1;
            final String s = MinecraftFontRenderer.getFormatFromString(this.field_178676_b.getColorPrefix());
            if (s.length() >= 2) {
            ...
            GL11.glColor4f(p_178663_1_, p_178663_1_, p_178663_1_, alpha / 255.0f);
