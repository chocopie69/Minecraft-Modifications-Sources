...
public class GuiRenameAlt extends GuiScreen
{
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        if (this.nameField.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "New name", (float)(GuiRenameAlt.width / 2 - 96), 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "New password", (float)(GuiRenameAlt.width / 2 - 96), 106.0f, -7829368);
        }
