...
import Velo.impl.Modules.visuals.Animations;
...
public class ItemRenderer
{
    ...
    private void func_178105_d(float p_178105_1_)
    {
        ...
        if(Animations.isEnabled) {
        	if(Animations.hitmode.equalsIgnorecase("Invasion")) {
        		return;
        	}
        }
        GlStateManager.translate(f, f1, f2);
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
    	if(!Animations.isEnabled) {
    		...
    		if(mc.thePlayer.isBlocking()) {
    			GlStateManager.translate(Animations.transX.getValue(), Animations.transY.getValue(), -0.71999997F);
	    		if(Animations.mode.equalsIgnorecase("Normal")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    		...
	    		if(Animations.mode.equalsIgnorecase("Tap2")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        GlStateManager.translate(0F, 0F + funny/15, -0);
			        GlStateManager.rotate(-12.0F, 0.0F, 1.0F, 0.0F);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);        
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.rotate(f1 * -45.0F, 1.0F, 0.0F, 0.0F);
	    	        GlStateManager.scale(0.42F, 0.42, 0.42F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("OldExhibition")) {
		      		float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        ...
			        GlStateManager.rotate(var4 * -10.0F, 1.0F, 0.2F, 1.0F);
			        GlStateManager.rotate(var4 * -25.0F, 1F, 0.4F, 0.9F);
			        GlStateManager.scale(0.38F, 0.38F, 0.38F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("Slide")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        GlStateManager.translate(0F, 0F + funny/20, -0);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);        
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    		...
	    		if(Animations.mode.equalsIgnorecase("Swang")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        ...
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.rotate(f1 * -45.0F, 1.0F, 0.0F, 0.0F);
	    	        GlStateManager.rotate(f * -20.0F, 0.0F, 1F, 0.0F);
	    	        //GlStateManager.rotate(f * -15.0F, 0.0F, 0F, 1.0F);
	    	        GlStateManager.scale(0.38F, 0.38F, 0.38F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("Swank")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.translate(0.0F, 0.0F, 0.0F);
	    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
	    		...
	    		if(Animations.mode.equalsIgnorecase("Ohareware")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.translate(0.0F, 0.0F, 0.0F);
	    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
	    		...
	    		if(Animations.mode.equalsIgnorecase("Wtf")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        float f2 = MathHelper.sin(MathHelper.sqrt_float(((System.currentTimeMillis()) % 600 / 600F)) * (float)Math.PI);
	    	        GlStateManager.rotate(f2 * -60F, 1.0F, 0, 0);
	    	        GlStateManager.scale(0.38F, 0.38F, 0.38F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("Exhibobo")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.translate(0.0F - funny/100, 0.0F + funny/25F, 0.0F + funny/15);
	    	        GlStateManager.rotate(45F, 0.0F, 1.0F, 0.0F);
	    	        //GlStateManager.rotate(-10.0F, 0.0F, 1.0F, 0.0F);
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        GlStateManager.rotate(f1 * -40.0F, 1F, 0.4F, 0.9F);
			        GlStateManager.rotate(f1 * -20F, 1F, 0F, 0F);
	    	        GlStateManager.scale(0.38F, 0.38F, 0.38F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("Tap")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.translate(0.0F - funny/100, 0.0F + funny/25F, 0.0F + funny/15);
	    	        GlStateManager.rotate(45F, 0.0F, 1.0F, 0.0F);
	    	        ...
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        GlStateManager.rotate(f1 * -35.0F, 1F, 0.4F, 0.9F);
			        GlStateManager.rotate(f1 * -20F, 1F, 0F, 0F);
	    	        GlStateManager.scale(0.38F, 0.38F, 0.38F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("MoonExhibobo")) {
		      		float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        GlStateManager.translate(0F, 0F + funny/25, -0);
			        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);        
			        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
			        //GlStateManager.rotate(-10.0F, 0.0F, 1.0F, 0.0F);
			        float var3 = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
			        ...
			        GlStateManager.rotate(var4 * -10.0F, 1.0F, 0.2F, 1.0F);
			        GlStateManager.rotate(var4 * -35.0F, 1F, 0.4F, 0.9F);
			        GlStateManager.scale(0.38F, 0.38F, 0.38F);
	    		}
	    		if(Animations.mode.equalsIgnorecase("Exhibobo2")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.translate(0.0F - funny/100, 0.0F + funny/15F, 0.0F + funny/15);
	    	        GlStateManager.rotate(45F, 0.0F, 1.0F, 0.0F);
	    	        //GlStateManager.rotate(-10.0F, 0.0F, 1.0F, 0.0F);
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    		...
	    		if(Animations.mode.equalsIgnorecase("AstolfoSpin")) {
	    			float funny = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
	    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
	    	        GlStateManager.translate(0.0F + ((System.currentTimeMillis()) % 1200 / 1200F) * -0.5F, 0.0F, 0.0F);
	    	        GlStateManager.rotate(45F, 0.0F, 1.0F, 0.0F);
	    	        //GlStateManager.rotate(-10.0F, 0.0F, 1.0F, 0.0F);
	    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
	    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
			        //GlStateManager.rotate(f1 * -40.0F, 1F, 0.4F, 0.9F);
			        GlStateManager.rotate(((System.currentTimeMillis()) % 1200 / 1200F) * -360F, 1F, 0, 0);
			        //GlStateManager.rotate(((System.currentTimeMillis()) % 1200 / 1200F) * -360F, 1F, 1F, 1F);
	    	        GlStateManager.scale(0.4F, 0.4F, 0.4F);
	    		}
    		} else {
    			GlStateManager.translate(0.56, -0.52F, -0.71999997F);
    	        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
    	        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
    	        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
    	        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        this.transformFirstPersonItem((float) (f * Animations.idkmultiplier.getValue()), f1);
                        this.func_178103_d();
                        break;
