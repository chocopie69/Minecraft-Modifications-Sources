...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class CategoryEntry implements IGuiListEntry
    {
        ...
        public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
            final MinecraftFontRenderer fontRendererObj = GuiKeyBindingList.this.mc.fontRendererObj;
            final String labelText = this.labelText;
            final float x2 = (float)(GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2);
            final int n = y + slotHeight;
            final MinecraftFontRenderer fontRendererObj2 = GuiKeyBindingList.this.mc.fontRendererObj;
            fontRendererObj.drawString(labelText, x2, (float)(n - 9 - 1), 16777215);
        }
    ...
    public class KeyEntry implements IGuiListEntry
    {
        ...
        public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
            ...
            final float x2 = (float)(x + 90 - GuiKeyBindingList.this.maxListLabelWidth);
            final int n = y + slotHeight / 2;
            final MinecraftFontRenderer fontRendererObj2 = GuiKeyBindingList.this.mc.fontRendererObj;
            fontRendererObj.drawString(keyDesc, x2, (float)(n - 9 / 2), 16777215);
