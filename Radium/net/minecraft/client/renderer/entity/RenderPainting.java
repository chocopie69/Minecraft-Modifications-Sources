    ...
    private void renderPainting(final EntityPainting painting, final int width, final int height, final int textureU, final int textureV) {
        ...
        for (int i = 0; i < width / 16; ++i) {
            for (int j = 0; j < height / 16; ++j) {
                ...
                worldrenderer.pos(f16, f19, -f3).tex(f21, f22).func_181663_c(0.0f, 0.0f, -1.0f).endVertex();
                worldrenderer.pos(f17, f19, -f3).tex(f20, f22).func_181663_c(0.0f, 0.0f, -1.0f).endVertex();
                worldrenderer.pos(f17, f18, -f3).tex(f20, f23).func_181663_c(0.0f, 0.0f, -1.0f).endVertex();
                worldrenderer.pos(f16, f18, -f3).tex(f21, f23).func_181663_c(0.0f, 0.0f, -1.0f).endVertex();
                worldrenderer.pos(f16, f18, f3).tex(f4, f6).func_181663_c(0.0f, 0.0f, 1.0f).endVertex();
                worldrenderer.pos(f17, f18, f3).tex(f5, f6).func_181663_c(0.0f, 0.0f, 1.0f).endVertex();
                worldrenderer.pos(f17, f19, f3).tex(f5, f7).func_181663_c(0.0f, 0.0f, 1.0f).endVertex();
                worldrenderer.pos(f16, f19, f3).tex(f4, f7).func_181663_c(0.0f, 0.0f, 1.0f).endVertex();
                worldrenderer.pos(f16, f18, -f3).tex(f8, f10).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f18, -f3).tex(f9, f10).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f18, f3).tex(f9, f11).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f18, f3).tex(f8, f11).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f19, f3).tex(f8, f10).func_181663_c(0.0f, -1.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f19, f3).tex(f9, f10).func_181663_c(0.0f, -1.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f19, -f3).tex(f9, f11).func_181663_c(0.0f, -1.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f19, -f3).tex(f8, f11).func_181663_c(0.0f, -1.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f18, f3).tex(f13, f14).func_181663_c(-1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f19, f3).tex(f13, f15).func_181663_c(-1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f19, -f3).tex(f12, f15).func_181663_c(-1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f16, f18, -f3).tex(f12, f14).func_181663_c(-1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f18, -f3).tex(f13, f14).func_181663_c(1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f19, -f3).tex(f13, f15).func_181663_c(1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f19, f3).tex(f12, f15).func_181663_c(1.0f, 0.0f, 0.0f).endVertex();
                worldrenderer.pos(f17, f18, f3).tex(f12, f14).func_181663_c(1.0f, 0.0f, 0.0f).endVertex();
                tessellator.draw();
            }
        }
    }
