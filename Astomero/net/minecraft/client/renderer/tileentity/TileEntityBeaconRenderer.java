    ...
    public void renderTileEntityAt(final TileEntityBeacon te, final double x, final double y, final double z, final float partialTicks, final int destroyStage) {
        ...
        if (f > 0.0f) {
            ...
            for (int j = 0; j < list.size(); ++j) {
                final TileEntityBeacon.BeamSegment tileentitybeaconbeamsegment = list.get(j);
                final int k = i + tileentitybeaconbeamsegment.getHeight();
                ...
                final float f2 = tileentitybeaconbeamsegment.getColors()[0];
                final float f3 = tileentitybeaconbeamsegment.getColors()[1];
                final float f4 = tileentitybeaconbeamsegment.getColors()[2];
                ...
                final double d16 = tileentitybeaconbeamsegment.getHeight() * f * 2.5 + d15;
                ...
                d12 = 1.0;
                d13 = -1.0 + d2;
                d14 = tileentitybeaconbeamsegment.getHeight() * f + d13;
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
