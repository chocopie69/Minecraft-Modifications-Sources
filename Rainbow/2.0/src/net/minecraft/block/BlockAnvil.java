...
public class BlockAnvil extends BlockFalling
{
    ...
    public IBlockState getStateFromMeta(final int meta) {
        if (ModuleManager.getModule("CrashFix").getInstance().isEnabled()) {
            return this.getDefaultState().withProperty(BlockAnvil.FACING, EnumFacing.getHorizontal(meta));
        }
        return this.getDefaultState().withProperty(BlockAnvil.FACING, EnumFacing.getHorizontal(meta)).withProperty(BlockAnvil.DAMAGE, (meta & 0xF) >> 2);
    }
