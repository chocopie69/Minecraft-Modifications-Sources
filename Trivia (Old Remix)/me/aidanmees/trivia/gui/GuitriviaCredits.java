...
public class GuitriviaCredits extends GuiScreen {

	private GuiScreen before;

	public GuitriviaCredits(GuiScreen before) {
		this.before = before;
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj,
				"§rHe was one of the first youtubers to make a video with trivia", 30, 235, 0xffffffff);
