...
public class GuiSnooper extends GuiScreen {
	...
	public void initGui() {
		...
		for (Entry<String, String> entry : (new TreeMap<String, String>(
			...
			if(Jigsaw.ghostMode && entry.getKey().equals("launched_version")) {
				value = Jigsaw.fakeClientVersion;
			}
			this.field_146604_g.add((flag ? "C " : "") + key);
			this.field_146609_h
					.add(this.fontRendererObj.trimStringToWidth(value, this.width - 220));
		}
