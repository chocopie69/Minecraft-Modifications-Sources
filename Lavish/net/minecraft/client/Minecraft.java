...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (NotWhitelisted.AuthURL != "https://pastebin.com/raw/2xpDhMHA") {
            getMinecraft().shutdownMinecraftApplet();
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading " + Client.instance.name);
        try {
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = DefaultResourcePack.getResourceStream(new ResourceLocation("Lavish/LavishIcon16x16.png"));
                inputstream2 = DefaultResourcePack.getResourceStream(new ResourceLocation("Lavish/LavishIcon32x32.png"));
    ...
    private void runGameLoop() throws IOException {
        Client.instance.onGameLoopTick();
    ...
    public void launchIntegratedServer(final String folderName, final String worldName, WorldSettings worldSettingsIn) {
        ...
        Client.instance.kills = 0;
        Client.instance.startTime = System.currentTimeMillis();
    }
