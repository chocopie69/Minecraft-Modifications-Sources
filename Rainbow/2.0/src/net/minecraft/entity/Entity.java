...
import slavikcodd3r.rainbow.module.modules.misc.RainbowUserFind;
import slavikcodd3r.rainbow.module.modules.movement.Scaffold;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void setPosition(double x, double y, double z)
    {
        ...
        final AxisAlignedBB bb = new AxisAlignedBB(x - var7, y, z - var7, x + var7, y + var8, z + var7);
        final BoundingBoxEntityEvent event = new BoundingBoxEntityEvent(this, bb);
        event.call();
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = (((new SafeWalk().getInstance().isEnabled()) || this.onGround && this.isSneaking() && this instanceof EntityPlayer));
            ...
            this.onGround = (((new AlwaysGround().getInstance().isEnabled()) && (this == Minecraft.getMinecraft().thePlayer)) || ((this.isCollidedVertically) && (var15 < 0.0D)));
    ...
    public float getDistanceToTileEntity(TileEntityChest entityIn)
    {
        float var2 = (float)(this.posX - entityIn.getPos().getX());
        float var3 = (float)(this.posY - entityIn.getPos().getY());
        float var4 = (float)(this.posZ - entityIn.getPos().getZ());
        return MathHelper.sqrt_float(var2 * var2 + var3 * var3 + var4 * var4);
    }
    ...
    public boolean isRainbowUser() {
        return this.isRainbowUser;
    }
    
    public void setRainbowUser(final boolean value) {
        this.isRainbowUser = value;
    }
    ...
    public IChatComponent getDisplayName() {
        ...
        if (RainbowUserFind.toggled) {
            var1 = new ChatComponentText("[Rainbow User] " + this.getName());
        }
