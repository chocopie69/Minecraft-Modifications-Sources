...
import slavikcodd3r.rainbow.module.modules.render.CameraNoClip;
import slavikcodd3r.rainbow.module.modules.render.Fullbright;
import slavikcodd3r.rainbow.module.modules.render.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
            ...
            else
            {
                ...
                for (int var20 = 0; var20 < 8; ++var20)
                {
                    ...
                    if (var24 != null)
                    {
                        ...
                        if ((var25 < var28) && (!new CameraNoClip().getInstance().isEnabled())) {
                            var28 = var25;
                          }
                    }
                }
    ...
    private void updateLightmap(float partialTicks)
    {
      if (this.lightmapUpdateNeeded)
      {
        ...
        if (var2 != null)
        {
          if (CustomColorizer.updateLightmap(var2, this.torchFlickerX, this.lightmapColors, (this.mc.thePlayer.isPotionActive(Potion.nightVision)) || (new Fullbright().getInstance().isEnabled())))
          {
          ...
          for (int var3 = 0; var3 < 256; var3++)
          {
            ...
            if ((this.mc.thePlayer.isPotionActive(Potion.nightVision)) || (new Fullbright().getInstance().isEnabled()))
            {
    ...
    {
        int var3 = new Fullbright().getInstance().isEnabled() ? Integer.MAX_VALUE : p_180438_1_.getActivePotionEffect(Potion.nightVision).getDuration();
