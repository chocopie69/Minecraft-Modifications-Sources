...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void drawHoveringText(final List<String> textLines, final int x, final int y) {
        if (!textLines.isEmpty()) {
            ...
            Gui.drawGradientRect((float)(l1 - 3), (float)(i2 - 4), (float)(l1 + i + 3), (float)(i2 - 3), m, m);
            Gui.drawGradientRect((float)(l1 - 3), (float)(i2 + k + 3), (float)(l1 + i + 3), (float)(i2 + k + 4), m, m);
            Gui.drawGradientRect((float)(l1 - 3), (float)(i2 - 3), (float)(l1 + i + 3), (float)(i2 + k + 3), m, m);
            Gui.drawGradientRect((float)(l1 - 4), (float)(i2 - 3), (float)(l1 - 3), (float)(i2 + k + 3), m, m);
            Gui.drawGradientRect((float)(l1 + i + 3), (float)(i2 - 3), (float)(l1 + i + 4), (float)(i2 + k + 3), m, m);
            final int i3 = 1347420415;
            final int j2 = (i3 & 0xFEFEFE) >> 1 | (i3 & 0xFF000000);
            Gui.drawGradientRect((float)(l1 - 3), (float)(i2 - 3 + 1), (float)(l1 - 3 + 1), (float)(i2 + k + 3 - 1), i3, j2);
            Gui.drawGradientRect((float)(l1 + i + 2), (float)(i2 - 3 + 1), (float)(l1 + i + 3), (float)(i2 + k + 3 - 1), i3, j2);
            Gui.drawGradientRect((float)(l1 - 3), (float)(i2 - 3), (float)(l1 + i + 3), (float)(i2 - 3 + 1), i3, i3);
            Gui.drawGradientRect((float)(l1 - 3), (float)(i2 + k + 2), (float)(l1 + i + 3), (float)(i2 + k + 3), j2, j2);
    ...
    public void drawBackground(final int tint) {
        ...
        worldrenderer.pos(0.0, this.height, 0.0).tex(0.0, this.height / 32.0f + tint).color4i(64, 64, 64, 255).endVertex();
        worldrenderer.pos(this.width, this.height, 0.0).tex(this.width / 32.0f, this.height / 32.0f + tint).color4i(64, 64, 64, 255).endVertex();
        worldrenderer.pos(this.width, 0.0, 0.0).tex(this.width / 32.0f, tint).color4i(64, 64, 64, 255).endVertex();
