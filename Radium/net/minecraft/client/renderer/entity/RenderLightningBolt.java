            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i2 = l; i2 >= m; --i2) {
                    ...
                    for (int j2 = 0; j2 < 5; ++j2) {
                        ...
                        worldrenderer.pos(d11 + d3, y + i2 * 16, d12 + d4).color4f(0.45f, 0.45f, 0.5f, 0.3f).endVertex();
                        worldrenderer.pos(d9 + d5, y + (i2 + 1) * 16, d10 + d6).color4f(0.45f, 0.45f, 0.5f, 0.3f).endVertex();
                    }
                    tessellator.draw();
                }
            }
