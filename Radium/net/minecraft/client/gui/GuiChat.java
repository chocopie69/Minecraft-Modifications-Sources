...
public class GuiChat extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        Gui.drawRect(2.0f, (float)(this.height - 14), (float)Math.max(GuiNewChat.calculateChatboxWidth(this.mc.gameSettings.chatWidth) + 5, this.fontRendererObj.getStringWidth(this.inputField.getText()) + 7), (float)(this.height - 2), Integer.MIN_VALUE);
