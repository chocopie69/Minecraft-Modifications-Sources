...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void moveEntity(double x, double y, double z) {
      ...
      Massacre.INSTANCE.getEventManager().post(eventMove);
   ...
   public void onUpdateWalkingPlayer() {
      EventUpdate event = new EventUpdate(this.mc.thePlayer.posX, this.getEntityBoundingBox().minY, this.mc.thePlayer.posZ, this.mc.thePlayer.rotationYaw, this.mc.thePlayer.rotationPitch, this.mc.thePlayer.lastReportedYaw, this.mc.thePlayer.lastReportedPitch, this.mc.thePlayer.onGround, EventUpdate.Type.PRE);
      ...
      if (this.isCurrentViewEntity()) {
         ...
         if (event.isRotating()) {
            this.rotationYawHead = GuiUtils.interpolate(event.getPrevYaw(), event.getYaw(), 0.0F);
            this.renderYawOffset = GuiUtils.interpolate(event.getPrevYaw(), event.getYaw(), 0.0F);
         }
         ...
         event.setType(EventUpdate.Type.POST);
         Massacre.INSTANCE.getEventManager().post(event);
      }
   ...
   public void setPlayerSPHealth(float health) {
      if (this.hasValidHealth) {
         ...
         if (f <= 0.0F) {
            ...
            if (f < 0.0F) {
               this.hurtResistantTime = maxHurtResistantTime / 2;
            }
         } else {
            this.lastDamage = f;
            this.setHealth(this.getHealth());
            this.hurtResistantTime = maxHurtResistantTime;
   ...
   public void onLivingUpdate() {
      ...
      if (this.isUsingItem() && !this.isRiding() && !Massacre.INSTANCE.getModuleManager().getModule("No Slow Down").getState()) {
