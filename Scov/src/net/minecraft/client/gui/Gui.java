...
public class Gui
{
     ...
     */
    public void drawCenteredString(VanillaFontRenderer fontRendererIn, String text, int x, int y, int color)
    {
     ...
     */
    public void drawString(VanillaFontRenderer fontRendererIn, String text, int x, int y, int color)
    {
