...
import Velo.impl.Modules.combat.Hitbox;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && (this.isSneaking() || Scaffold.SafewalkEnabled) && this instanceof EntityPlayer;
...
float box = 0.1f;
        if (ModuleManager.get("Hitbox").isEnabled()) {
        	box = (float) (box + hitBox.hitbox.getValue());
        }
        if (!ModuleManager.get("Hitbox").isEnabled()) {
        	box = 0.1f;
        }
