...
public class DefaultVertexFormats
{
    ...
    public static final VertexFormat field_181703_c = new VertexFormat(); //1
    public static final VertexFormat field_181704_d = new VertexFormat(); //2
    public static final VertexFormat field_181705_e = new VertexFormat(); //3
    public static final VertexFormat field_181706_f = new VertexFormat(); //4
    public static final VertexFormat POSITION_TEX = new VertexFormat(); //5
    public static final VertexFormat field_181708_h = new VertexFormat(); //6
    public static final VertexFormat field_181709_i = new VertexFormat(); //7
    public static final VertexFormat field_181710_j = new VertexFormat(); //8
    public static final VertexFormat field_181711_k = new VertexFormat(); //9
    public static final VertexFormat field_181712_l = new VertexFormat(); //10
