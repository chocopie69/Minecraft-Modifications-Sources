...
public class Criticals extends Module {
	...
	public void critical(Entity en) {
		...
		if(en instanceof EntityLivingBase) {
			if(((EntityLivingBase) en).hurtTime < 3) {
		...
		sendPacketFinal(new C03PacketPlayer.C04PacketPlayerPosition(x, y + 0.05, z, false).setCrit(true));
		sendPacketFinal(new C03PacketPlayer.C04PacketPlayerPosition(x, y, z, false).setCrit(true));
		sendPacketFinal(new C03PacketPlayer.C04PacketPlayerPosition(x, y + 0.015, z, false).setCrit(true));
		sendPacketFinal(new C03PacketPlayer.C04PacketPlayerPosition(x, y, z, false).setCrit(true));
	}
	...
	public static void crit(double xx, double yy, double zz) {
		...
		mc.getNetHandler().getNetworkManager().sendPacketFinal(
				new C03PacketPlayer.C04PacketPlayerPosition(x, y + 0.05, z, false).setCrit(true));
		mc.getNetHandler().getNetworkManager()
				.sendPacketFinal(new C03PacketPlayer.C04PacketPlayerPosition(x, y, z, false).setCrit(true));
		mc.getNetHandler().getNetworkManager().sendPacketFinal(
				new C03PacketPlayer.C04PacketPlayerPosition(x, y + 0.015, z, false).setCrit(true));
		mc.getNetHandler().getNetworkManager()
				.sendPacketFinal(new C03PacketPlayer.C04PacketPlayerPosition(x, y, z, false).setCrit(true));
	}
