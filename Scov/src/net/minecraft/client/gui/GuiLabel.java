...
public class GuiLabel extends Gui
{
    ...
    private VanillaFontRenderer fontRenderer;
    private int field_146163_s;

    public GuiLabel(VanillaFontRenderer fontRendererObj, int p_i45540_2_, int p_i45540_3_, int p_i45540_4_, int p_i45540_5_, int p_i45540_6_, int p_i45540_7_)
    {
