...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderNameNoNameTag(final T entity, final double x, final double y, final double z) {
        if (this.canRenderName(entity)) {}
    }
    
    public void doRenderNoNameTag(final T entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
