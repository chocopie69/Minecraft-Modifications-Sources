...
import Lavish.event.events.EventChat;
...
public class GuiNewChat extends Gui
{
                    ...
                    if (chatline != null) {
                        ...
                        if (j2 < 200 || flag) {
                            ...
                            if (l2 > 3) {
                                ...
                                this.mc.fontRendererObj.drawStringWithShadow(s, (float)i3, (float)(j3 - 8 - HUD.ylevel), 16777215 + (l2 << 24));
    ...
    public void printChatMessageWithOptionalDeletion(final IChatComponent p_146234_1_, final int p_146234_2_) {
        ...
        final EventChat e = new EventChat(p_146234_1_);
        Client.instance.onEvent(e);
        if (e.getChatComponent().getUnformattedText().contains("by " + this.mc.getSession().getUsername()) || e.getChatComponent().getUnformattedText().contains("por " + this.mc.getSession().getUsername()) || e.getChatComponent().getUnformattedText().contains("manos de " + this.mc.getSession().getUsername())) {
            final Client instance = Client.instance;
            ++instance.kills;
        }
        if (e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " hacking") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " is hacking") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " hack") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " hacker") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " hacks") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " cheating") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " is a cheater") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " cheats") || e.getChatComponent().getFormattedText().contains(String.valueOf(this.mc.getSession().getUsername()) + " cheater")) {
            this.mc.thePlayer.playSound("random.levelup", 50.0f, 10.0f);
        }
    }
    ...
    public IChatComponent getChatComponent(final int p_146236_1_, final int p_146236_2_) {
        ...
        int k = p_146236_2_ / i - 27 - HUD.ylevel;
