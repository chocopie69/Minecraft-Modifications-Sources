...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Velo.api.Main.Main.onClientStartup();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading Velo 0.3 Beta...");
    ...
    public void displayInGameMenu()
    {
        if (this.currentScreen == null)
        {
            ...
            {
            	GuiConnecting.adress = "Singleplayer";
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                    	...
                    	Velo.api.Event.EventManager.onKeyPress(k);
                    	EventKey event = new EventKey(k);
                    	EventManager.onKeypress(event);
