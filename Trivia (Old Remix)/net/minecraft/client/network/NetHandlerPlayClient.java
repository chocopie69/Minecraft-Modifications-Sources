...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
		...
		if (entity != null) {
			if (!trivia.getModuleByName("AntiVelocity").isToggled()) {
			entity.setVelocity((double) packetIn.getMotionX() / 8000.0D, (double) packetIn.getMotionY() / 8000.0D,
				...
				if (ClientSettings.KBHorizontal != 0 || ClientSettings.KBVertical != 0) {
				double himp = (ClientSettings.KBHorizontal/10) / 100; //normal kb
				double vimp = (ClientSettings.KBVertical/10) / 100; //normal kb
			
				entity.setVelocity((double) packetIn.getMotionX() * himp, (double) packetIn.getMotionY() * vimp,
						(double) packetIn.getMotionZ() * himp);
				}
			}
