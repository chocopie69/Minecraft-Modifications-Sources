...
public final class GuiAltLogin extends GuiScreen
{
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        if (this.username.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "Username / E-Mail", (float)(GuiAltLogin.width / 2 - 96), 66.0f, -7829368);
        }
        if (this.password.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "Password", (float)(GuiAltLogin.width / 2 - 96), 106.0f, -7829368);
        }
