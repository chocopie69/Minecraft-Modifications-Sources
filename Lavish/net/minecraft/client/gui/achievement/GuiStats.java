...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected void func_148209_a(final StatBase p_148209_1_, final int p_148209_2_, final int p_148209_3_, final boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                ...
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, (float)(p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s)), (float)(p_148209_3_ + 5), p_148209_4_ ? 16777215 : 9474192);
            }
            else {
                final String s2 = "-";
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, (float)(p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s2)), (float)(p_148209_3_ + 5), p_148209_4_ ? 16777215 : 9474192);
            }
        }
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, statbase.getStatName().getUnformattedText(), (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 1), (entryID % 2 == 0) ? 16777215 : 9474192);
            final String s = statbase.format(GuiStats.this.field_146546_t.readStat(statbase));
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, (float)(p_180791_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s)), (float)(p_180791_3_ + 1), (entryID % 2 == 0) ? 16777215 : 9474192);
        }
    }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s, (float)(p_180791_2_ + 2 - 10), (float)(p_180791_3_ + 1), 16777215);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT), (i == 0) ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s3, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2), (j == 0) ? 6316128 : 9474192);
        }
    }
}
