...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void setRenderItemGui(final boolean renderItemGui) {
    ...
    private void renderEffect(final IBakedModel model) {
        if ((!Config.isCustomItems() || CustomItems.isUseGlint()) && (!Config.isShaders() || !Shaders.isShadowPass)) {
            ...
            final int col = EnchantGlint.isGlintEnabled() ? EnchantGlint.getItemColor() : -8372020;
    ...
    public void renderItemOverlays(final MinecraftFontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition) {
        this.renderItemOverlayIntoGUI(fr, stack, xPosition, yPosition, null);
    }
    
    public void renderItemOverlayIntoGUI(final MinecraftFontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, final String text) {
        if (stack != null) {
