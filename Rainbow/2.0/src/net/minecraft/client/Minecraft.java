...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void run()
    {
        ...
        try
        {
        	if (!Rainbow.purchased) {
        		System.out.println(Rainbow.rainbowprotection + " " + "ОШИБКА: Чит не куплен");
        		System.out.println(Rainbow.rainbowprotection + " " + "Вы не купили Rainbow 2.0 и не сможете запустить его!");
        		System.out.println(Rainbow.rainbowprotection + " " + "Купить чит - vk.com/slavikskidd3r");
        		JOptionPane.showMessageDialog(null, "Вы не купили " + Rainbow.name + " " + Rainbow.version +  " и не сможете запустить его!\nКупить чит - " + Rainbow.vk, Rainbow.rainbowprotectiondialog, JOptionPane.ERROR_MESSAGE);
