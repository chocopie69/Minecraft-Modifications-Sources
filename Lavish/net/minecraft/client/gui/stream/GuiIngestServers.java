...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, ingestserver.serverName, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 5), 16777215);
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT + 5 + 3), 3158064);
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s2, (float)(this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s2)), (float)(p_180791_3_ + 5), 8421504);
            if (s3 != null) {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s3, (float)(this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s3)), (float)(p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT), 8421504);
            }
        }
