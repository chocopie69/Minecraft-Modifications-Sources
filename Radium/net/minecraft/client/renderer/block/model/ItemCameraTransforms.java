...
public class ItemCameraTransforms
{
    ...
    public void func_181689_a(final TransformType p_181689_1_) {
        ...
        if (itemtransformvec3f != ItemTransformVec3f.DEFAULT) {
            GL11.glTranslatef(itemtransformvec3f.translation.x + ItemCameraTransforms.field_181690_b, itemtransformvec3f.translation.y + ItemCameraTransforms.field_181691_c, itemtransformvec3f.translation.z + ItemCameraTransforms.field_181692_d);
            GL11.glRotatef(itemtransformvec3f.rotation.y + ItemCameraTransforms.field_181694_f, 0.0f, 1.0f, 0.0f);
            GL11.glRotatef(itemtransformvec3f.rotation.x + ItemCameraTransforms.field_181693_e, 1.0f, 0.0f, 0.0f);
            GL11.glRotatef(itemtransformvec3f.rotation.z + ItemCameraTransforms.field_181695_g, 0.0f, 0.0f, 1.0f);
            GL11.glScalef(itemtransformvec3f.scale.x + ItemCameraTransforms.field_181696_h, itemtransformvec3f.scale.y + ItemCameraTransforms.field_181697_i, itemtransformvec3f.scale.z + ItemCameraTransforms.field_181698_j);
        }
    }
