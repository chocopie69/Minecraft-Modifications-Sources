...
import rip.helium.cheat.impl.misc.AutoPlay;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Helium.eventBus.publish(renderOverlayEvent);
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            this.zLevel = -90.0F;
            int y = 0;
        	int color = ColorCreator.createRainbowFromOffset(3200, y * -15);
            this.drawTexturedModalRect(i - 91, sr.getScaledHeight() - 22, 0, 0, 182, 22);
            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            this.zLevel = f;
            if(!(mc.currentScreen instanceof GuiChat)) {
                //Gui.drawRect( i - 91 - 1 + entityplayer.inventory.currentItem * 20 + 1, this.getScaledRes().getScaledHeight() - 22, this.getScaledRes().getScaledWidth() - i - 91 - 1 + (entityplayer.inventory.currentItem * 20) + 22, this.getScaledRes().getScaledHeight(), 0x406F03CD);
                //R2DUtils.drawBorderedRect( i - 91 - 1 + entityplayer.inventory.currentItem * 20 + 1, this.getScaledRes().getScaledHeight() - 22, this.getScaledRes().getScaledWidth() - i - 91 - 1 + (entityplayer.inventory.currentItem * 20) + 22, this.getScaledRes().getScaledHeight(),2, color,  ColorCreator.createRainbowFromOffset(3200, y * -15));
                //R2DUtils.drawBorderedRect(0, this.getScaledRes().getScaledHeight() - 22, this.getScaledRes().getScaledWidth(), this.getScaledRes().getScaledHeight(),2, 0x80000000, 0x90000000); this.zLevel = f;
    ...
    public void func_181551_a(ScaledResolution p_181551_1_) {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
            ...
            if (k > 0) {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                mc.fontRendererObj.drawStringWithShadow(s, (float) i, (float) j, 16777215 + (k << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    public void renderDemo(ScaledResolution p_175185_1_) {
        ...
        mc.fontRendererObj.drawStringWithShadow(s, (float) (p_175185_1_.getScaledWidth() - i - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }

    protected boolean showCrosshair() {
        if (Helium.instance.cheatManager.isCheatEnabled("Crosshair"))
            return false;
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        for (Object score10 : arraylist1) {
            ...
            int value = rip.helium.cheat.impl.visual.Hud.down.getValue().intValue();
            int l = value + k1 - k * this.getFontRenderer().FONT_HEIGHT;
            int i1 = p_180475_2_.getScaledWidth() - b0 + 2;
            if (rip.helium.cheat.impl.visual.Hud.scoreboard_enabled.getValue()) {
            	if (rip.helium.cheat.impl.visual.Hud.scoreboard_background.getValue()) {
            	drawRect(j - 2, l, i1, l + this.getFontRenderer().FONT_HEIGHT, 1342177280);
            	}
            }
            if (rip.helium.cheat.impl.visual.Hud.scoreboard_enabled.getValue()) {
            	mc.fontRendererObj.drawStringWithShadow(s1, j, l, 553648127);
            }
            
            mc.fontRendererObj.drawStringWithShadow(s2, i1 - this.getFontRenderer().getStringWidth(s2), l, 553648127);
            ...
            if (!(mc.currentScreen instanceof GuiDownloadTerrain) || Objects.nonNull(mc.thePlayer)) {
                ...
                boolean autoplay = Helium.instance.cheatManager.isCheatEnabled("AutoPlay");
            ...
            if (k == arraylist1.size()) {
                ...
                if (rip.helium.cheat.impl.visual.Hud.scoreboard_enabled.getValue()) {
                	mc.fontRendererObj.drawStringWithShadow(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - 10, 553648127);
                    nigger = s3;
                    //.out.println(s3 + "\n" + nigger);
                	}
                }
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            mc.fontRendererObj.drawStringWithShadow(s, (float) (i / 2 - this.getFontRenderer().getStringWidth(s) / 2), (float) (b0 - 10), 16777215);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
