...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(final int width, final Scoreboard scoreboardIn, final ScoreObjective scoreObjectiveIn) {
        ...
        if (list2 != null) {
            final float left = (float)(width / 2 - l4 / 2 - 1);
            final float top = (float)(k2 - 1);
            final float right = (float)(width / 2 + l4 / 2 + 1);
            final int n = k2;
            final int size = list2.size();
            final MinecraftFontRenderer fontRendererObj = this.mc.fontRendererObj;
            Gui.drawRect(left, top, right, (float)(n + size * 9), Integer.MIN_VALUE);
        ...
        if (list3 != null) {
            k2 = k2 + i2 * 9 + 1;
            final float left2 = (float)(width / 2 - l4 / 2 - 1);
            final float top2 = (float)(k2 - 1);
            final float right2 = (float)(width / 2 + l4 / 2 + 1);
            final int n3 = k2;
            final int size2 = list3.size();
            final MinecraftFontRenderer fontRendererObj3 = this.mc.fontRendererObj;
            Gui.drawRect(left2, top2, right2, (float)(n3 + size2 * 9), Integer.MIN_VALUE);
            for (final String s5 : list3) {
                ...
                final int n4 = k2;
                final MinecraftFontRenderer fontRendererObj4 = this.mc.fontRendererObj;
                k2 = n4 + 9;
            }
        }
    }
