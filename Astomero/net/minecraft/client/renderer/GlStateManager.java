...
{
    public static AlphaState alphaState;
    public static BooleanState lightingState;
    public static BooleanState[] lightState;
    public static ColorMaterialState colorMaterialState;
    public static BlendState blendState;
    public static DepthState depthState;
    public static FogState fogState;
    public static CullState cullState;
    public static PolygonOffsetState polygonOffsetState;
    public static ColorLogicState colorLogicState;
    public static TexGenState texGenState;
    public static ClearState clearState;
    public static StencilState stencilState;
    public static BooleanState normalizeState;
    public static int activeTextureUnit;
    public static TextureState[] textureState;
    public static int activeShadeModel;
    public static BooleanState rescaleNormalState;
    public static ColorMask colorMaskState;
    ...
    public static void texGen(final TexGen p_179149_0_, final int p_179149_1_) {
        final TexGenCoord glstatemanagertexgencoord = texGenCoord(p_179149_0_);
        if (p_179149_1_ != glstatemanagertexgencoord.field_179066_c) {
            glstatemanagertexgencoord.field_179066_c = p_179149_1_;
            GL11.glTexGeni(glstatemanagertexgencoord.field_179065_b, 9472, p_179149_1_);
        }
    }
    ...
    public static TexGenCoord texGenCoord(final TexGen p_179125_0_) {
        switch (GlStateManager1.field_179175_a[p_179125_0_.ordinal()]) {
            case 1: {
    ...
    public static void deleteTexture(final int texture) {
        if (texture != 0) {
            ...
            for (final TextureState glstatemanagertexturestate : GlStateManager.textureState) {
    ...
    static final class GlStateManager1
    {
        ...
        static {
            ...
            try {
                GlStateManager1.field_179175_a[TexGen.S.ordinal()] = 1;
            }
            catch (NoSuchFieldError noSuchFieldError) {}
            try {
                GlStateManager1.field_179175_a[TexGen.T.ordinal()] = 2;
            }
            catch (NoSuchFieldError noSuchFieldError2) {}
            try {
                GlStateManager1.field_179175_a[TexGen.R.ordinal()] = 3;
            }
            catch (NoSuchFieldError noSuchFieldError3) {}
            try {
                GlStateManager1.field_179175_a[TexGen.Q.ordinal()] = 4;
            }
    ...
    static class AlphaState
    {
        ...
        AlphaState(final GlStateManager1 p_i46489_1_) {
            this();
        }
    }
    ...
    static class BlendState
    {
        ...
        BlendState(final GlStateManager1 p_i46488_1_) {
            this();
        }
    }
    ...
    static class ClearState
    {
        ...
        ClearState(final GlStateManager1 p_i46487_1_) {
            this();
        }
    }
    ...
    static class ColorLogicState
    {
        ...
        ColorLogicState(final GlStateManager1 p_i46486_1_) {
            this();
        }
    }
    ...
    static class ColorMask
    {
        ...
        ColorMask(final GlStateManager1 p_i46485_1_) {
            this();
        }
    }
    ...
    static class ColorMaterialState
    {
        ...
        ColorMaterialState(final GlStateManager1 p_i46484_1_) {
            this();
        }
    }
    ...
    static class CullState
    {
        ...
        CullState(final GlStateManager1 p_i46483_1_) {
            this();
        }
    }
    ...
    static class DepthState
    {
        ...
        DepthState(final GlStateManager1 p_i46482_1_) {
            this();
        }
    }
    ...
    static class FogState
    {
        ...
        FogState(final GlStateManager1 p_i46481_1_) {
            this();
        }
    }
    ...
    static class PolygonOffsetState
    {
        ...
        PolygonOffsetState(final GlStateManager1 p_i46480_1_) {
            this();
        }
    }
    ...
    static class StencilFunc
    {
        ...
        StencilFunc(final GlStateManager1 p_i46479_1_) {
            this();
        }
    }
    ...
    static class StencilState
    {
        ...
        StencilState(final GlStateManager1 p_i46478_1_) {
            this();
        }
    }
    ...
    public enum TexGen
    {
        ...
        public static final TexGen[] VALUES;
    ...
    static class TexGenState
    {
        ...
        TexGenState(final GlStateManager1 p_i46477_1_) {
            this();
        }
    }
    ...
    public static class TextureState
    {
        ...
        TextureState(final GlStateManager1 p_i46476_1_) {
            this();
        }
    }
}
