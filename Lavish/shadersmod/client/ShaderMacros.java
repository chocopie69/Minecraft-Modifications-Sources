...
public class ShaderMacros
{
    ...
    public static final String MC_GL_VERSION;
    public static final String MC_GLSL_VERSION;
    public static final String MC_OS_WINDOWS;
    public static final String MC_OS_MAC;
    public static final String MC_OS_LINUX;
    public static final String MC_OS_OTHER;
    public static final String MC_GL_VENDOR_ATI;
    public static final String MC_GL_VENDOR_INTEL;
    public static final String MC_GL_VENDOR_NVIDIA;
    public static final String MC_GL_VENDOR_XORG;
    public static final String MC_GL_VENDOR_OTHER;
    public static final String MC_GL_RENDERER_RADEON;
    public static final String MC_GL_RENDERER_GEFORCE;
    public static final String MC_GL_RENDERER_QUADRO;
    public static final String MC_GL_RENDERER_INTEL;
    public static final String MC_GL_RENDERER_GALLIUM;
    public static final String MC_GL_RENDERER_MESA;
    public static final String MC_GL_RENDERER_OTHER;
