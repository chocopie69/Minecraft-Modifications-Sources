...
import Velo.api.Util.menu.Element.GLSLSandboxShader;
...
public float logoanimy = -1;
	...
	throw new IllegalStateException("Failed to load shader");
		}
 ...
 //       this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));
   //     this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alt Manager"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	//System.out.println(logoanimy + "");
       
    	//  Fonts.mm2.drawStringWithShadow(Main.name, (float) ScaledRes.getScaledWidth() / 2, (float) ScaledRes.getScaledHeight() / 2 - 110, new Color(255, 255, 255).getRGB());
      ...
      //  Fonts.mm2.drawStringWithShadow(Main.name, (float) ScaledRes.getScaledWidth() / 2, (float) ScaledRes.getScaledHeight() / 2 - 110, new Color(0, 0, 0, 255).getRGB());
      ...
      //      this.drawTexturedModalRect(j + 0, k + 0, 0, 0, 99, 44);
       ...
       //     this.drawTexturedModalRect(j + 155, k + 0, 0, 45, 155, 44);
            ...
            //  Fonts.mm2.drawCenteredString(Main.name, (float) ScaledRes.getScaledWidth() / 2, (float) ScaledRes.getScaledHeight() / 2 - 110, new Color(255, 255, 255).getRGB());
ScaledResolution sr = new ScaledResolution(mc);
        GlStateManager.pushMatrix();
   //     GlStateManager.translate((float)(this.width / 2 + 90), 70.0F, 0.0F);
        GlStateManager.rotate(0, 0,0, 10);
       float f = 1.8F - MathHelper.abs(MathHelper.sin((float)(Minecraft.getSystemTime() % 1000L) / 1000.0F * (float)Math.PI * 2.0F) * 0.1F);
       f = f * 100.0F / (float)(this.fontRendererObj.getStringWidth(this.splashText) + 32);
      //  GlStateManager.scale(f, f, f);
        Fonts.MM.drawCenteredString(Main.name, width/ 2, sr.getScaledHeight() / 2 - 115 + logoanimy, new Color(255, 255, 255).getRGB());
    ...
    //    this.drawString(this.fontRendererObj, s1, this.width - this.fontRendererObj.getStringWidth(s1) - 2, this.height - 10, -1);
        ...
        String[] buttons = {"Singleplayer", "Multiplayer", "Option", "Login"}; 
    	...
    	for(String name : buttons) {
        	...
        	if(mouseX >= x && mouseY >= y && mouseX < x + Fonts.mm2.getStringWidth("Singleplayer") + 10 && mouseY < y + Fonts.mm2.getStringHeight("Singleplayer") + 7) {
        		hovered = true;
        	}else {
        		hovered = false;
        	}
    		...
    		Fonts.mm1.drawCenteredString(name,this.width /2, this.height / 2 - 70 + (count * 30) + 30, hovered ? 0x90000000: -1);
    		count ++;
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
    	...
    	String[] buttons = {"Singleplayer", "Multiplayer", "Options", "Login"}; 
    	int count = 0;
    	
    	for(String name : buttons) {
    		float x = this.width /2 - 30;
    		float y = this.height / 2 - 70 + (count * 30) + 27;
    		if(mouseX >= x && mouseY >= y && mouseX < x + Fonts.mm2.getStringWidth("Singleplayer") + 20 && mouseY < y + Fonts.mm2.getStringHeight("Singleplayer")) {
    			switch(name) {
    			case "Singleplayer":
