...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void func_180453_a(final FontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, final String text) {
        if (stack != null) {
            ...
            boolean itemDamaged2 = stack.isItemDamaged();
            if (Reflector.ForgeItem_showDurabilityBar.exists()) {
                itemDamaged2 = Reflector.callBoolean(stack.getItem(), Reflector.ForgeItem_showDurabilityBar, stack);
            }
            if (itemDamaged2) {
                ...
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    final double var8 = Reflector.callDouble(stack.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, stack);
                    i = (int)Math.round(13.0 - var8 * 13.0);
                    j = (int)Math.round(255.0 - var8 * 255.0);
                }
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
