...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public void swingItem() {
		// TODO Rave NoSwing
		if (trivia.getModuleByName("NoSwing").isToggled()) {
			return;
		}
		super.swingItem();
	...
	public void setSprinting(boolean sprinting) {
		String mode = trivia.getModuleByName("Sprint").getCurrentMode();
		if(trivia.getModuleByName("Sprint").isToggled()) {
	...
	public void onLivingUpdate() {
		...
		if (!trivia.getModuleByName("NoClip").isToggled()
		...
		if (this.isRidingHorse()) {
			...
			if (trivia.getModuleByName("PerfectHorseJump").isToggled()) {
	...
	//TODO trivia onDeath
		...
		public boolean onLiquid()
		  {
		    double y = this.posY - 0.03D;
		    for (int x = MathHelper.floor(this.posX); x < MathHelper.ceiling_double_int(this.posX); x++) {
		      for (int z = MathHelper.floor(this.posZ); z < MathHelper.ceiling_double_int(this.posZ); z++)
		      {
