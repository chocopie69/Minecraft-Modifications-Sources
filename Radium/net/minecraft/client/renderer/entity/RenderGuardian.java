...
public class RenderGuardian extends RenderLiving<EntityGuardian>
{
    ...
    public void doRender(final EntityGuardian entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (entitylivingbase != null) {
            ...
            GL11.glRotatef((1.5707964f + -f7) * 57.295776f, 0.0f, 1.0f, 0.0f);
            GL11.glRotatef(f6 * 57.295776f, 1.0f, 0.0f, 0.0f);
            final int i = 1;
            ...
            worldrenderer.pos(d13, d0, d14).tex(0.4999, d24).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d13, 0.0, d14).tex(0.4999, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d15, 0.0, d16).tex(0.0, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d15, d0, d16).tex(0.0, d24).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d17, d0, d18).tex(0.4999, d24).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d17, 0.0, d18).tex(0.4999, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d19, 0.0, d20).tex(0.0, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d19, d0, d20).tex(0.0, d24).color4i(j, k, l, 255).endVertex();
            double d25 = 0.0;
            if (entity.ticksExisted % 2 == 0) {
                d25 = 0.5;
            }
            worldrenderer.pos(d5, d0, d6).tex(0.5, d25 + 0.5).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d7, d0, d8).tex(1.0, d25 + 0.5).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d11, d0, d12).tex(1.0, d25).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d9, d0, d10).tex(0.5, d25).color4i(j, k, l, 255).endVertex();
            tessellator.draw();
            GL11.glPopMatrix();
        }
    }
