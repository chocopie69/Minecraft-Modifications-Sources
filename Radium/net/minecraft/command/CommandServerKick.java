...
public class CommandServerKick extends CommandBase
{
    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (flag) {
            CommandBase.notifyOperators(sender, this, "commands.kick.success.reason", entityplayermp.getCommandSenderName(), s);
        }
        else {
            CommandBase.notifyOperators(sender, this, "commands.kick.success", entityplayermp.getCommandSenderName());
        }
    }
