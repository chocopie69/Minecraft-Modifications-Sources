...
import slavikcodd3r.rainbow.module.modules.render.XRay;
...
public class Block
{
    ...
    {
    	 return !XRay.isXray && (this.blockMaterial.blocksMovement() && this.isFullCube());
    }
