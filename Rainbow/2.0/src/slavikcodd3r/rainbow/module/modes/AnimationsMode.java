...
public class AnimationsMode extends BooleanOption
{
    public AnimationsMode(final String name, final boolean value, final Module module) {
    ...
    public void setValue(final Boolean value) {
        if (value) {
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof AnimationsMode) {
            ...
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof AnimationsMode && option != this) {
