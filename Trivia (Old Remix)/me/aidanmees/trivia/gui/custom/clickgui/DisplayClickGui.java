...
public class DisplayClickGui extends GuiScreen {
	...
	public void initGui() {
		...
		trivia.getClickGuiManager().globalAlphaMinus = 1f;
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		for(ModuleWindow wind : Lists.reverse(trivia.getClickGuiManager().windows)) {
		...
		ClickGuiManager manager = trivia.getClickGuiManager();
	...
	public void updateScreen() {
		...
		if(trivia.getClickGuiManager().globalAlphaMinus > 0.0f) {
			trivia.getClickGuiManager().globalAlphaMinus -= trivia.getClickGuiManager().getAlphaDec();
		}
		if(trivia.getClickGuiManager().globalAlphaMinus <= 0.0f) {
			trivia.getClickGuiManager().globalAlphaMinus = 0.0f;
		}
		ClickGuiManager manager = trivia.getClickGuiManager();
		manager.update();
		super.updateScreen();
	...
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		...
		mouseDown = false;
		dragged = false;
		for(ModuleWindow wind : trivia.getClickGuiManager().windows) {
