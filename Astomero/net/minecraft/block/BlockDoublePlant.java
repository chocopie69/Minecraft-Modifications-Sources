...
public class BlockDoublePlant extends BlockBush implements IGrowable
{
    ...
    public boolean isReplaceable(final World worldIn, final BlockPos pos) {
        ...
        final EnumPlantType blockdoubleplantenumplanttype = this.getActualState(iblockstate, worldIn, pos).getValue(BlockDoublePlant.VARIANT);
        return blockdoubleplantenumplanttype == EnumPlantType.FERN || blockdoubleplantenumplanttype == EnumPlantType.GRASS;
    }
