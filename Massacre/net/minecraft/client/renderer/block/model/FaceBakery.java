...
public class FaceBakery {
   ...
   private void applyFacing(int[] p_applyFacing_1_, EnumFacing p_applyFacing_2_) {
      ...
      for(int k = 0; k < 4; ++k) {
         j1 = j * k;
         float f1 = Float.intBitsToFloat(aint[j1]);
         float f2 = Float.intBitsToFloat(aint[j1 + 1]);
         f = Float.intBitsToFloat(aint[j1 + 2]);
      ...
      for(j1 = 0; j1 < 4; ++j1) {
         ...
         p_applyFacing_1_[k1] = Float.floatToRawIntBits(f);
