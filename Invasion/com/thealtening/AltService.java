...
public class AltService {
    ...
    private static ReflectionUtility userAuthentication = new ReflectionUtility("com.mojang.authlib.yggdrasil.YggdrasilUserAuthentication");
    private static ReflectionUtility minecraftSession = new ReflectionUtility("com.mojang.authlib.yggdrasil.YggdrasilMinecraftSessionService");
    private static EnumAltService currentService;

    public static void switchService(EnumAltService enumAltService) throws NoSuchFieldException, IllegalAccessException {
    ...
    private static void reflectionFields(String authServer) throws NoSuchFieldException, IllegalAccessException {
    ...
    private static URL constantURL(final String url) {
        try {
            return new URL(url);
