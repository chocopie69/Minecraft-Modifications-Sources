...
public class Gui
{
     ...
     */
    public static void drawHorizontalLine(double left, double right, double up, int color)
    {
        if (right < left)
        {
            int i = (int) left;
        ...
        drawRect(left, up, right + 1, up + 1, color);
    }

    /**
     * Draw a 1 pixel wide vertical line. Args : x, y1, y2, color
     */
    public static void drawVerticalLine(double left, double up, double down, int color)
    {
        if (down < up)
        {
            int i = (int) up;
        ...
        drawRect(left, up + 1, left + 1, down, color);
    }
     ...
     */
    public static void drawGradientRect(float left, float g, double d, float i, int startColor, int endColor)
    {
        ...
        worldrenderer.pos((double)d, (double)g, (double)zLevel).color(f1, f2, f3, f).endVertex();
        worldrenderer.pos((double)left, (double)g, (double)zLevel).color(f1, f2, f3, f).endVertex();
        worldrenderer.pos((double)left, (double)i, (double)zLevel).color(f5, f6, f7, f4).endVertex();
        worldrenderer.pos((double)d, (double)i, (double)zLevel).color(f5, f6, f7, f4).endVertex();
        tessellator.draw();
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(double d, double e, float u, float v, float imageSpace, float imageSpace2, float textureWidth, float textureHeight)
    {
