...
public class Jigsaw {
	...
	private static String clientVersion = "1.8x0.26 DEV 3";
	public static final String fakeClientVersion = "1.8.8-Optifine_HD_U_D6";
...
//	public static final ResourceLocation jigsawImage6 = new ResourceLocation("jigsaw/MainMenuImage0.jpg");
	public static final ResourceLocation jigsawImage7 = new ResourceLocation("jigsaw/lowpoly.png");
	public static final ResourceLocation jigsawImage8 = new ResourceLocation("jigsaw/lowpolydark.png");
	public static final ResourceLocation jigsawImage9 = new ResourceLocation("jigsaw/lowpolypurple.png");
	...
	public static ArrayList<AbstractPacket> packetQueue = new ArrayList<AbstractPacket>();
...
//		try {
//			PrintWriter writer = new PrintWriter(new File(Minecraft.class.getResource("users").getPath()));
//			writer.println(System.getProperty("user.name") + " | " + mc.session.getUsername() + " - " + mc.session.getSessionType() + " : ");
//			writer.flush();
//			writer.close();
//		} catch (Exception e1) {
//			e1.printStackTrace();
//		} 
		...
		images = new ResourceLocation[] { jigsawImage9, jigsawImage7, jigsawImage8, };
		...
		moduleGroupMananger.addGroup(new ModuleGroup(new Module[] { Jigsaw.getModuleByName("KillAura"),
				...
				Jigsaw.getModuleByName("Aimbot"), Jigsaw.getModuleByName("OP-Fightbot") }, "AuraGroup"));
	...
	public static final Category[] defaultCategoriesWithTarget = new Category[] { Category.AUTOMATION, Category.COMBAT,
			Category.MOVEMENT, Category.MISC, Category.RENDER, Category.FUN, Category.MINIGAMES, Category.PLAYER,
...
//		}
	...
	public static void OnLateUpdate() {
		...
		for(AbstractPacket packet : packetQueue) {
	...
	public static void queuePacketToLateUpdate(AbstractPacket packet) {
