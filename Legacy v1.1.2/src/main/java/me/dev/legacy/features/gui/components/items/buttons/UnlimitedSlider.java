...
public class UnlimitedSlider
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Legacy.textManager.drawStringWithShadow(" - " + this.setting.getName() + " " + ChatFormatting.GRAY + this.setting.getValue() + ChatFormatting.WHITE + " +", this.x + 2.3f, this.y - 1.7f - (float) OyVeyGui.getClickGui().getTextOffset(), this.getState() ? -2 : -5592406);
    }
