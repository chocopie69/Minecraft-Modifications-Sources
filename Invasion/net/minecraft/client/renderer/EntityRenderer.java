...
import net.minecraft.client.renderer.entityrenderers.EntityRenderer1;
import net.minecraft.client.renderer.entityrenderers.EntityRenderer2;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventManager.onRender3DUpdate(event3d);
