    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (flag && itemstack.stackSize <= 0) {
            ...
            if (entityitem2 != null) {
                ...
                entityitem2.setOwner(entityplayer.getCommandSenderName());
            }
        }
        CommandBase.notifyOperators(sender, this, "commands.give.success", itemstack.getChatComponent(), i, entityplayer.getCommandSenderName());
    }
