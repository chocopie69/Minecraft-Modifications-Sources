...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback {
	...
	public void updateScreen() {
		...
		if (this.enableButtonsTimer == 20) { //TODO this.enableButtonsTimer == 20 var den först
			for (GuiButton guibutton : this.buttonList) {
				guibutton.enabled = true;
			}
		}
		if (this.enableButtonsTimer == 100) { //TODO this.enableButtonsTimer == 20 var den först
			for (GuiButton guibutton : this.buttonList) {
				if(guibutton.displayString.startsWith("Try GodMode (")) {
					guibutton.enabled = false;
				}
