...
import slavikcodd3r.rainbow.module.modules.combat.NoSwing;
import slavikcodd3r.rainbow.module.modules.fun.Desu;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public float setRotationPitchHead(final float var) {
        return this.rotationPitchHead = var;
    }
    ...
    {
    	// System.out.println((float) (Math.random() * 1000000000));
    ...
    {
    	if (((new Desu().getInstance().isEnabled()))) {
            this.sendQueue.addToSendQueue(new C01PacketChatMessage(p_71165_1_ + " desu"));
            logger.info("[CLIENT CHAT] " + p_71165_1_ + " desu");
    	} else {
        this.sendQueue.addToSendQueue(new C01PacketChatMessage(p_71165_1_));
        logger.info("[CLIENT CHAT] " + p_71165_1_);
    	}
    }
    /**
    ...
    {
    	if (!(new NoSwing().getInstance().isEnabled())) {
        super.swingItem();
