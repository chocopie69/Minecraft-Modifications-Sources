...
public abstract class Entity implements ICommandSender
{
    ...
    public void spawnRunningParticles() {
        ...
        if (Client.instance.moduleManager.getModuleByName("Scaffold").isEnabled() && Minecraft.getMinecraft().thePlayer.moveForward > 0.0f && Client.instance.setmgr.getSettingByName("Sprint").getValBoolean() && this.entityId == Minecraft.getMinecraft().thePlayer.getEntityId()) {
            this.createRunningParticles();
        }
    }
