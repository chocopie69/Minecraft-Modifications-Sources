...
public class GuiShaders extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, String.valueOf(this.screenTitle) + " ", GuiShaders.width / 2, 15, 16777215);
        ...
        if (i < GuiShaders.width - 5) {
            ...
            this.drawString(this.fontRendererObj, s, 5.0f, (float)(GuiShaders.height - 40), 8421504);
        }
