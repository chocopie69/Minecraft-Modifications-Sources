...
public class Gui {
	 ...
	 */
	public static void drawRect(double x, double startY, double d, double e, int color) {
		if (x < d) {
			int i = (int) x;
			x = d;
			d = i;
		...
		worldrenderer.pos((double) d, (double) startY, 0.0D).endVertex();
		worldrenderer.pos((double) x, (double) startY, 0.0D).endVertex();
		tessellator.draw();
