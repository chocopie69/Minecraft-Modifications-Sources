         ...
         for(int i = 0; i < 16; ++i) {
            for(int j = 0; j < 16; ++j) {
               if (this.updateSkylightColumns[i + j * 16]) {
                  ...
                  Iterator var8;
                  Object enumfacing1;
                  for(var8 = EnumFacing.Plane.HORIZONTAL.iterator(); var8.hasNext(); j1 = Math.min(j1, this.worldObj.getChunksLowestHorizon(l + ((EnumFacing)enumfacing1).getFrontOffsetX(), i1 + ((EnumFacing)enumfacing1).getFrontOffsetZ()))) {
                     enumfacing1 = var8.next();
                  }
