...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, I18n.format("addServer.enterName", new Object[0]), (float)(GuiScreenAddServer.width / 2 - 100), 53.0f, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("addServer.enterIp", new Object[0]), (float)(GuiScreenAddServer.width / 2 - 100), 94.0f, 10526880);
