...
import me.robbanrobbin.jigsaw.crash.JigsawCrashReporter;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	private void startGame() throws LWJGLException, IOException {
		...
		boolean hadToCreateFolder = false;
		
		if(!mcResourcePackRepository.dirServerResourcepacks.exists()) {
			mcResourcePackRepository.dirServerResourcepacks.mkdirs();
			hadToCreateFolder = true;
		}
		...
		if(hadToCreateFolder) {
			Jigsaw.getNotificationManager().addNotification(new Notification(Level.INFO, "Created folder 'server-resource-packs' because it didnt exist..."));
		}
//		this.fontRendererObj = Fonts.font18;
	...
	public void displayCrashReport(CrashReport crashReportIn) {
		...
		//TODO Jigsaw crash report to server
		JigsawCrashReporter.sendCrashReportToServer(crashReportIn);
...
//		}
	...
	public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
		if(worldClientIn != null) { //TODO Jigsaw loadWorld detect thing
			Jigsaw.onLoadWorld();
		}
