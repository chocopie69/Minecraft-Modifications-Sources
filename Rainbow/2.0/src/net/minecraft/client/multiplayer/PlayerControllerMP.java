...
import slavikcodd3r.rainbow.module.modules.player.AbortBreaking;
...
public class PlayerControllerMP
{
    ...
    {
        if (this.isHittingBlock && !(new AbortBreaking().getInstance().isEnabled()))
        {
    ...
    {
        final ReachEvent event = new ReachEvent(this.currentGameType.isCreative() ? 5.0f : 4.5f);
        event.call();
    ...
    public boolean func_178890_a(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_, BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3 vec3d)
    {
        this.syncCurrentPlayItem();
        float var7 = (float)(vec3d.xCoord - (double)p_178890_4_.getX());
        float var8 = (float)(vec3d.yCoord - (double)p_178890_4_.getY());
        float var9 = (float)(vec3d.zCoord - (double)p_178890_4_.getZ());
        boolean var10 = false;
    ...
    public boolean func_1788901_a(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_, BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3d vec3d)
    {
        this.syncCurrentPlayItem();
        float var7 = (float)(vec3d.xCoord - (double)p_178890_4_.getX());
        float var8 = (float)(vec3d.yCoord - (double)p_178890_4_.getY());
    ...
    {
        Event.call(new AttackEvent(playerIn, targetEntity));
        this.syncCurrentPlayItem();
    ...
    public void func_178890_a(final EntityPlayerSP thePlayer, final WorldClient theWorld, final ItemStack stack, final BlockPos position, final EnumFacing face, final Vec3d vec3d) {
        this.func_178890_a(thePlayer, theWorld, stack, position, face, new Vec3(vec3d.xCoord, vec3d.yCoord, vec3d.zCoord));
    }
}
