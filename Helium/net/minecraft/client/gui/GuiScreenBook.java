...
public class GuiScreenBook extends GuiScreen
{
    ...
    private void sendBookToServer(final boolean p_146462_1_) throws IOException {
        if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
            ...
            ChatUtil.chat("§fYour item should have enchanted! If it was not, then it's patched on the server.");
            ChatUtil.chat("§fThe server version for it to work§f: §d1.7.10");
        }
    }
