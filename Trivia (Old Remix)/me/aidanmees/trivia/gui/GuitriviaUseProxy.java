...
import me.aidanmees.trivia.client.tools.IPGetter;
...
public class GuitriviaUseProxy extends GuiScreen {
	...
	public GuitriviaUseProxy(GuiScreen before) {
		this.before = before;
		if(trivia.proxy != null) {
			result = "§6Using proxy: §c" + trivia.proxy[0] + ":" + trivia.proxy[1];
		}
	}
