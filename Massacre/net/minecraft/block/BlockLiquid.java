...
public abstract class BlockLiquid extends Block {
   ...
   public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
      EventCollide eventCollide = new EventCollide((AxisAlignedBB)null, this, pos.getX(), pos.getY(), pos.getZ());
      return eventCollide.getAxisAlignedBB();
   }
   ...
   protected Vec3 getFlowVector(IBlockAccess worldIn, BlockPos pos) {
      ...
      BlockPos blockpos1;
      while(var5.hasNext()) {
         enumfacing1 = var5.next();
         blockpos1 = pos.offset((EnumFacing)enumfacing1);
      ...
      if ((Integer)worldIn.getBlockState(pos).getValue(LEVEL) >= 8) {
         ...
         do {
            ...
            enumfacing1 = var5.next();
            blockpos1 = pos.offset((EnumFacing)enumfacing1);
         } while(!this.isBlockSolid(worldIn, blockpos1, (EnumFacing)enumfacing1) && !this.isBlockSolid(worldIn, blockpos1.up(), (EnumFacing)enumfacing1));
