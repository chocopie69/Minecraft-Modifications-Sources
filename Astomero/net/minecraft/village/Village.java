...
public class Village
{
    ...
    public void addOrRenewAgressor(final EntityLivingBase entitylivingbaseIn) {
        for (final VillageAggressor villagevillageaggressor : this.villageAgressors) {
    ...
    public EntityLivingBase findNearestVillageAggressor(final EntityLivingBase entitylivingbaseIn) {
        ...
        VillageAggressor villagevillageaggressor = null;
        for (int i = 0; i < this.villageAgressors.size(); ++i) {
            final VillageAggressor villagevillageaggressor2 = this.villageAgressors.get(i);
            final double d2 = villagevillageaggressor2.agressor.getDistanceSqToEntity(entitylivingbaseIn);
            if (d2 <= d0) {
                villagevillageaggressor = villagevillageaggressor2;
                d0 = d2;
            }
        }
    ...
    private void removeDeadAndOldAgressors() {
        ...
        while (iterator.hasNext()) {
            final VillageAggressor villagevillageaggressor = iterator.next();
