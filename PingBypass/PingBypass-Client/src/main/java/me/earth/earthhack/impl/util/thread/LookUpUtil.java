...
public class LookUpUtil implements Globals
{
    ...
    public static UUID getUUIDSimple(String name)
    {
        ...
        if (mc.getConnection() != null)
        {
            ...
            NetworkPlayerInfo profile = infoMap.stream().filter(networkPlayerInfo ->
    ...
    public static String findNextPlayerName(String input)
    {
        if (mc.getConnection() != null)
        {
            ...
            NetworkPlayerInfo profile = infoMap.stream().filter(info ->
                    TextUtil.startsWithIgnoreCase(info.getGameProfile().getName(), input)).findFirst().orElse(null);
        ...
        {
            if (TextUtil.startsWithIgnoreCase(str, input))
            {
                return str;
            }
        }
