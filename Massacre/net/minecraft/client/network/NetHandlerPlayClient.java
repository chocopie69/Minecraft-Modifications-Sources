...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
      ...
      ServerPosLookEvent serverPosLookEvent = new ServerPosLookEvent(packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getYaw(), packetIn.getPitch(), packetIn.getYaw(), packetIn.getPitch());
      Massacre.INSTANCE.getEventManager().post(serverPosLookEvent);
   ...
   public void addToSendQueue(Packet p_147297_1_) {
      ...
      Massacre.INSTANCE.getEventManager().post(eventPacket);
      if (!eventPacket.isCancelled()) {
         this.netManager.sendPacket(eventPacket.getPacket());
      }
   }
