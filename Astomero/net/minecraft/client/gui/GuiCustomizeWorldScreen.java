            ...
            switch (button.id) {
                ...
                case 301: {
                    for (int i = 0; i < this.field_175349_r.getSize(); ++i) {
                        final GuiPageButtonList.GuiEntry guipagebuttonlistguientry = this.field_175349_r.getListEntry(i);
                        final Gui gui = guipagebuttonlistguientry.func_178022_a();
                        ...
                        final Gui gui2 = guipagebuttonlistguientry.func_178021_b();
