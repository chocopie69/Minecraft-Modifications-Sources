...
public class Barrier extends EntityFX
{
    ...
    public void renderParticle(final WorldRenderer worldRendererIn, final Entity entityIn, final float partialTicks, final float p_180434_4_, final float p_180434_5_, final float p_180434_6_, final float p_180434_7_, final float p_180434_8_) {
        ...
        worldRendererIn.pos(f6 - p_180434_4_ * 0.5f - p_180434_7_ * 0.5f, f7 - p_180434_5_ * 0.5f, f8 - p_180434_6_ * 0.5f - p_180434_8_ * 0.5f).tex(f2, f4).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(j, k).endVertex();
        worldRendererIn.pos(f6 - p_180434_4_ * 0.5f + p_180434_7_ * 0.5f, f7 + p_180434_5_ * 0.5f, f8 - p_180434_6_ * 0.5f + p_180434_8_ * 0.5f).tex(f2, f3).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(j, k).endVertex();
        worldRendererIn.pos(f6 + p_180434_4_ * 0.5f + p_180434_7_ * 0.5f, f7 + p_180434_5_ * 0.5f, f8 + p_180434_6_ * 0.5f + p_180434_8_ * 0.5f).tex(f, f3).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(j, k).endVertex();
        worldRendererIn.pos(f6 + p_180434_4_ * 0.5f - p_180434_7_ * 0.5f, f7 - p_180434_5_ * 0.5f, f8 + p_180434_6_ * 0.5f - p_180434_8_ * 0.5f).tex(f, f4).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(j, k).endVertex();
    }
