...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    public static void drawEntityOnScreen(final int posX, final int posY, final int scale, final float mouseX, final float mouseY, final EntityLivingBase ent) {
        ...
        rendermanager.renderEntityWithPosYawWithNoNameTag(ent, 0.0, 0.0, 0.0, 0.0f, 1.0f);
    ...
    public static void drawEntityOnScreenWithoutName(final float g, final float h, final int scale, final float mouseX, final float mouseY, final EntityLivingBase ent) {
        GlStateManager.enableColorMaterial();
        GlStateManager.pushMatrix();
        GlStateManager.translate(g, h, 50.0f);
        GlStateManager.scale((float)(-scale), (float)scale, (float)scale);
        GlStateManager.rotate(180.0f, 0.0f, 0.0f, 1.0f);
        final float f = ent.renderYawOffset;
        final float f2 = ent.rotationYaw;
        ...
        rendermanager.setRenderShadow(false);
        rendermanager.renderEntityWithPosYawWithNoNameTag(ent, 0.0, 0.0, 0.0, 0.0f, 0.0f);
        rendermanager.setRenderShadow(true);
        ent.renderYawOffset = f;
        ent.rotationYaw = f2;
        ent.rotationPitch = f3;
