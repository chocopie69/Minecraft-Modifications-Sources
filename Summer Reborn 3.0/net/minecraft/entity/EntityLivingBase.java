...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        return  (int)(this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1 : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) * (!CheatManager.getInstance(Animations.class).isToggled() ? Animations.speedAni.getValFloat() : 1));
