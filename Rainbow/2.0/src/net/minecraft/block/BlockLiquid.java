...
public abstract class BlockLiquid extends Block
{
    ...
    {
        if (ModuleManager.getModule("LiquidInteract").getInstance().isEnabled()) {
            return true;
        }
        return false;
    }
    ...
    {
        return ModuleManager.getModule("LiquidInteract").getInstance().isEnabled() || p_176209_2_ && ((Integer)state.getValue(LEVEL)).intValue() == 0;
    }
