...
public class AuraUtils {
	...
	private static double smoothAimSpeed = 2.5;
	private static boolean smoothAim = false;
	...
	public static boolean getSmoothAim() {
		return smoothAim;
	}

	public static void setSmoothAim(boolean smoothAim) {
		AuraUtils.smoothAim = smoothAim;
	}
