...
public class Block {
   ...
   public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
      EventCollide eventCollide = new EventCollide(this.getCollisionBoundingBox(worldIn, pos, state), state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
      Massacre.INSTANCE.getEventManager().post(eventCollide);
