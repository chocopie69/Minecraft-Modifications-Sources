...
public class Framebuffer
{
    ...
    public void framebufferRenderExt(final int p_178038_1_, final int p_178038_2_, final boolean p_178038_3_) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            worldrenderer.pos(0.0, f2, 0.0).tex(0.0, 0.0).color4i(255, 255, 255, 255).endVertex();
            worldrenderer.pos(f, f2, 0.0).tex(f3, 0.0).color4i(255, 255, 255, 255).endVertex();
            worldrenderer.pos(f, 0.0, 0.0).tex(f3, f4).color4i(255, 255, 255, 255).endVertex();
            worldrenderer.pos(0.0, 0.0, 0.0).tex(0.0, f4).color4i(255, 255, 255, 255).endVertex();
            tessellator.draw();
            this.unbindFramebufferTexture();
