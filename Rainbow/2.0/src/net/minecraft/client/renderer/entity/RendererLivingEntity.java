...
import slavikcodd3r.rainbow.module.modules.render.ESP;
import slavikcodd3r.rainbow.module.modules.render.WallHack;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    {
    	if (new WallHack().getInstance().isEnabled()) {
            GL11.glEnable(32823);
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (var8 || var9)
        {
            ...
            if (new ESP().getInstance().isEnabled() && p_77036_1_ instanceof EntityPlayer) {	
