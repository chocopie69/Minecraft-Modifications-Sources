...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, s, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 1), 16777215);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, s2, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 12), 8421504);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, s3, (float)(p_180791_2_ + 2), (float)(p_180791_3_ + 12 + 10), 8421504);
        }
    }
}
