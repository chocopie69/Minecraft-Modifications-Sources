...
public class RenderManager
{
    ...
    {
        return this.renderEntityStatic(entityIn, partialTicks, false) && this.renderEntityStaticWithNoNametag(entityIn, partialTicks, false);
    }
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean p_147936_3_)
    {
        ...
        return this.doRenderEntity(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, p_147936_3_) && this.doRenderEntityWithNoNameTag(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, p_147936_3_);
    }
    
    public boolean renderEntityStaticWithNoNametag(Entity entity, float partialTicks, boolean p_147936_3_)
    {
        if (entity.ticksExisted == 0)
        {
            entity.lastTickPosX = entity.posX;
        ...
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)j / 1.0F, (float)k / 1.0F);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        return this.doRenderEntityWithNoNameTag(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, p_147936_3_);
    }
    ...
    {
        return this.doRenderEntity(entityIn, x, y, z, entityYaw, partialTicks, false) && this.doRenderEntityWithNoNameTag(entityIn, x, y, z, entityYaw, partialTicks, false);
    }
