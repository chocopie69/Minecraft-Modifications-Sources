...
import slavikcodd3r.rainbow.module.modules.misc.RainbowPacket;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void addToSendQueue(Packet p_147297_1_)
    {
        ...
        final PacketEvent XD = new PacketEvent(p_147297_1_, new Socket());
        Event.call(XD);
	...
	public void addToSendQueue(RainbowPacket rainbowPacket) {
	}
}
