...
public class RenderDragon extends RenderLiving<EntityDragon>
{
    ...
    protected void rotateCorpse(final EntityDragon bat, final float p_77043_2_, final float p_77043_3_, final float partialTicks) {
        ...
        if (bat.deathTime > 0) {
            ...
            GL11.glRotatef(f3 * this.getDeathMaxRotation(bat), 0.0f, 0.0f, 1.0f);
        }
    }
    ...
    protected void drawRechargeRay(final EntityDragon dragon, final double p_180574_2_, final double p_180574_4_, final double p_180574_6_, final float p_180574_8_) {
        ...
        GL11.glRotatef((float)(-Math.atan2(f6, f4)) * 180.0f / 3.1415927f - 90.0f, 1.0f, 0.0f, 0.0f);
        ...
        for (int j = 0; j <= 8; ++j) {
            ...
            worldrenderer.pos(f10 * 0.2f, f11 * 0.2f, 0.0).tex(f12, f9).color4i(0, 0, 0, 255).endVertex();
            worldrenderer.pos(f10, f11, f7).tex(f12, f8).color4i(255, 255, 255, 255).endVertex();
        }
        tessellator.draw();
