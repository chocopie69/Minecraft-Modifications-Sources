        ...
        if (mouseButton == 0) {
            for (final GuiButton button : this.buttonList) {
                if (button.mousePressed(this.mc, mouseX, mouseY)) {
                    ...
                    if (button.id == 2272) {
                        final Module mod = Astomero.instance.moduleManager.getModuleOrNull(KillAura.class);
                        if (!mod.isEnabled()) {
                            continue;
                        }
                        mod.toggle();
                        ...
                        final Module mod = Astomero.instance.moduleManager.getModuleOrNull(Stealer.class);
                        if (!mod.isEnabled()) {
                            continue;
                        }
                        mod.toggle();
                        ...
                        final Module mod = Astomero.instance.moduleManager.getModuleOrNull(InventoryManager.class);
                        if (!mod.isEnabled()) {
                            continue;
                        }
                        mod.toggle();
