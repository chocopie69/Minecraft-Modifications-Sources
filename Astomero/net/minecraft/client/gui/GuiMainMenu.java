...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    protected void renderSkybox(final int p_73971_1_, final int p_73971_2_, final float p_73971_3_) {
        ...
        final float f = (GuiMainMenu.width > GuiMainMenu.height) ? (120.0f / GuiMainMenu.width) : (120.0f / GuiMainMenu.height);
        final float f2 = GuiMainMenu.height * f / 256.0f;
        final float f3 = GuiMainMenu.width * f / 256.0f;
        final int i = GuiMainMenu.width;
        final int j = GuiMainMenu.height;
        final Tessellator tessellator = Tessellator.getInstance();
        final WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        GlStateManager.disableAlpha();
        final String s = "Astomero (#090821)";
        this.drawDefaultBackground();
        Gui.drawString(this.fontRendererObj, s, 2, GuiMainMenu.height - 10, -1);
        final StringBuilder append = new StringBuilder().append("Welcome, ");
        final Astomero instance = Astomero.instance;
        final String s2 = append.append(Astomero.getLoginUser).toString();
        Gui.drawString(this.fontRendererObj, s2, GuiMainMenu.width - this.fontRendererObj.getStringWidth(s2) - 2, GuiMainMenu.height - 10, -1);
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0) {
            ...
            Gui.drawString(this.fontRendererObj, this.openGLWarning2, (GuiMainMenu.width - this.field_92024_r) / 2, this.buttonList.get(0).yPosition - 12, -1);
        }
        this.buttonList.add(new GuiButton(500, GuiMainMenu.width / 2 - 100, GuiMainMenu.height / 4 + 48 + 48, "Alt Manager"));
