...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, s, 2.0f, (float)(GuiVideoSettings.height - 10), 8421504);
        final String s3 = "Minecraft 1.8.8";
        final int i = this.fontRendererObj.getStringWidth(s3);
        this.drawString(this.fontRendererObj, s3, (float)(GuiVideoSettings.width - i - 2), (float)(GuiVideoSettings.height - 10), 8421504);
