...
public class ItemRenderer
{
    ...
    private void animation(final float p_1780961, final float p_1780962) {
        GlStateManager.translate(0.56f, -0.52f, -0.71999997f);
        GlStateManager.translate(0.0f, p_1780961 * -0.6f, 0.0f);
        GlStateManager.rotate(45.0f, 0.0f, 1.0f, 0.0f);
        final float var4 = MathHelper.sin(MathHelper.sqrt_float(p_1780962) * 3.1415927f);
    ...
    private void transformFirstPersonItem(final float equipProgress, final float swingProgress) {
        ...
        float dstrength = 1.0f;
        float sstrength = 0.0f;
        GlStateManager.rotate(f2 * -80.0f * dstrength, 1.0f, sstrength, 0.0f);
        GlStateManager.scale(0.4f, 0.4f, 0.4f);
    }
    ...
    public void renderItemInFirstPerson(float p_78440_1_)
    {
        ...
        final float swingprogress2 = var3.getSwingProgress(p_78440_1_);
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (var3.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                {
                    ...
                    case 4:
                        this.animation(-0.3f, swingprogress2);
                        this.func_178103_d();
                        break;
                    case 5:
                        this.func_178096_b(var2, 0.0F);
