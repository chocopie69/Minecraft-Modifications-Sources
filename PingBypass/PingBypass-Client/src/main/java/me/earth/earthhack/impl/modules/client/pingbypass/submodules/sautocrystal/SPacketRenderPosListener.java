 ...
 */
public class SPacketRenderPosListener extends ModuleListener<ServerAutoCrystal, PacketEvent.Receive<SPacketSpawnExperienceOrb>>
{
    protected SPacketRenderPosListener(ServerAutoCrystal module)
    {
