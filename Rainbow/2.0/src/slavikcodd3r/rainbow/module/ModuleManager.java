...
import slavikcodd3r.rainbow.module.modules.render.Hud;
import slavikcodd3r.rainbow.utils.ClientUtils;
import slavikcodd3r.rainbow.utils.FileUtils;
...
public final class ModuleManager
{
    ...
    public static void start() {
        final Reflections reflections = new Reflections("slavikcodd3r.rainbow.module.modules", new Scanner[0]);
    ...
    public static List<Module> getModulesForRender() {
        ...
        renderList.sort(new Comparator<Module>() {
            ...
            public int compare(final Module m1, final Module m2) {
                ...
                return (int)Hud.font.getStringWidth(s2) - (int)Hud.font.getStringWidth(s1);
            }
        });
        return renderList;
    }
    
    public static List<Module> getModulesForRender2() {
        final List<Module> renderList = ModuleManager.moduleList;
        renderList.sort(new Comparator<Module>() {
            @Override
            public int compare(final Module m1, final Module m2) {
    ...
    public static List<Module> getModulesForRender3() {
        final List<Module> renderList = ModuleManager.moduleList;
        renderList.sort(new Comparator<Module>() {
            @Override
            public int compare(final Module m1, final Module m2) {
    ...
    public static List<Module> getModulesForRender4() {
        final List<Module> renderList = ModuleManager.moduleList;
        renderList.sort(new Comparator<Module>() {
            @Override
            public int compare(final Module m1, final Module m2) {
