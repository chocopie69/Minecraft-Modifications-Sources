...
public class PotionHelper {
      ...
      if (p_77911_0_ != null && !p_77911_0_.isEmpty()) {
         ...
         while(true) {
            ...
            do {
               ...
               Object potioneffect0 = var6.next();
               potioneffect = (PotionEffect)potioneffect0;
   ...
   public static boolean getAreAmbient(Collection potionEffects) {
      ...
      do {
         ...
         potioneffect = var1.next();
      } while(((PotionEffect)potioneffect).getIsAmbient());
      ...
      if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_) {
         ...
         if (i >= 0 && i < p_77912_2_) {
            ...
            if (j > 0) {
               ...
               k = parsePotionEffects(p_77912_0_, i + 1, p_77912_2_, p_77912_3_);
               return k > 0 ? k : 0;
            }
         } else {
            j = p_77912_0_.indexOf(38, p_77912_1_);
            if (j >= 0 && j < p_77912_2_) {
               k = parsePotionEffects(p_77912_0_, p_77912_1_, j - 1, p_77912_3_);
               if (k <= 0) {
                  return 0;
               } else {
