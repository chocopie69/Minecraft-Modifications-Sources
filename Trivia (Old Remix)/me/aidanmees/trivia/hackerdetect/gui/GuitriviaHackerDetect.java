package me.aidanmees.trivia.hackerdetect.gui;
...
public class GuitriviaHackerDetect extends GuiScreen {
	private GuiScreen before;
	public Hacker selected;
	public int scroll;

	public GuitriviaHackerDetect(GuiScreen before) {
		this.before = before;
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRendererObj, "trivia HackerDetect GUI BETA", width / 2, 5, 0xffdddddd);
	}
