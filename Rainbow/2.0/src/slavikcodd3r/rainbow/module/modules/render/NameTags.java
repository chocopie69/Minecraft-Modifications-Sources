...
import slavikcodd3r.rainbow.utils.RenderUtil;

@Module.Mod(displayName = "NameTags")
...
{   
	...
	public static void renderNametag(final EntityPlayer player, final double x, final double y2, final double z) {
        ...
        RenderUtil.rectangle(-var16, var15 - 2, var16, var15 + 10, new Color(32, 32, 33).getRGB());
        GlStateManager.func_179098_w();
        mc.fontRendererObj.func_175065_a(entityName, (float)(-var16), (float)var15, -1, true);
        if (player instanceof EntityPlayer) {
            ...
            for (final ItemStack stack2 : items) {
                ...
                mc.getRenderItem().func_175030_a(mc.fontRendererObj, stack2, -var16 + offset + xPos, var15 - 20);
                ...
                if (stack2.getItem() == Items.golden_apple && stack2.hasEffect()) {
                    mc.fontRendererObj.drawString("god", (int)((-var16 + offset + xPos) * 2), (float)((var15 - 20) * 2), -65536);
                }
                else {
                    final NBTTagList enchants = stack2.getEnchantmentTagList();
                    if (enchants != null) {
                        int encY = 0;
                        final Enchantment[] important = { Enchantment.unbreaking, Enchantment.fireAspect, Enchantment.efficiency, Enchantment.field_180309_e, Enchantment.power, Enchantment.flame, Enchantment.punch, Enchantment.fortune, Enchantment.infinity, Enchantment.thorns };
                                ...
                                if (enc != null) {
                                    for (final Enchantment importantEnchantment : important) {
                                        if (enc == importantEnchantment) {
                                            ...
                                            encName = ((level > 99) ? (String.valueOf(String.valueOf(String.valueOf(encName))) + "99+") : (String.valueOf(String.valueOf(String.valueOf(encName))) + level));
                                            mc.fontRendererObj.drawString(encName, (int)((-var16 + offset + xPos) * 2), (float)((var15 - 20 + encY) * 2), -5592406);
                                            encY += 5;
                                            break;
                                        }
                                    }
    ...
    private static void renderItemStack(final ItemStack stack, final int x, final int y2) {
        ...
        mc.getRenderItem().func_175030_a(mc.fontRendererObj, stack, x, y2);
        mc.getRenderItem().zLevel = 0.0f;
        GlStateManager.disableBlend();
	...
	@EventTarget
	public void Render3D(final Render3DEvent e) {
