...
public class FontUtils {
   public static Font deriveFontFromAssetsTTF(String fileName, int size) {
      try {
         return Font.createFont(0, Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("massacre/fonts/" + fileName)).getInputStream()).deriveFont(0, (float)size);
