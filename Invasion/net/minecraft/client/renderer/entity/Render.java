...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderOffsetLivingLabelfalse(T entityIn, double x, double y, double z, String str, float p_177069_9_, double p_177069_10_)
    {
       // this.renderLivingLabel(entityIn, str, x, y, z, 64);
    }
    ...
    protected void renderLivingLabelWithNoNameTag(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
