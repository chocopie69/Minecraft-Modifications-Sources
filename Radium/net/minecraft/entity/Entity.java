...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            final boolean flag = this.onGround && (this.isSneaking() || event.isCancelled()) && this instanceof EntityPlayer;
            if (flag) {
            ...
            if (this.stepHeight > 0.0f && flag2 && (d4 != x || d6 != z)) {
                final boolean isPlayer = this instanceof EntityPlayerSP;
                ...
                this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0, y, 0.0));
                if (isPlayer && y > -0.5) {
                    final double blockHeight = stepEvent.getStepHeight() + y;
                    final List<Double> blockHeights = Arrays.asList(0.875, 0.625, 0.8125, 0.9375, 0.75, 0.6875);
