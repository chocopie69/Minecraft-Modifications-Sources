...
public class GuiChat extends GuiScreen
{
    ...
    DecelerateAnimation anibps;
    DecelerateAnimation aniuid;
    ...
    @Override
    public void initGui() {
        (this.ani = new DecelerateAnimation(500, GuiChat.width - 2, Direction.FORWARDS)).reset();
        (this.anibps = new DecelerateAnimation(500, 15.0, Direction.FORWARDS)).reset();
        (this.aniuid = new DecelerateAnimation(500, 15.0, Direction.FORWARDS)).reset();
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        Gui.drawRect(2.0, GuiChat.height - 14, (int)this.ani.getOutput(), GuiChat.height - 2, Integer.MIN_VALUE);
        HUD.ylevel = (int)this.anibps.getOutput();
