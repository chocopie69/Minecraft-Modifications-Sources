...
public class DynamicLights
{
    ...
    private static final int LIGHT_LEVEL_MAX;
    private static final int LIGHT_LEVEL_FIRE;
    private static final int LIGHT_LEVEL_BLAZE;
    private static final int LIGHT_LEVEL_MAGMA_CUBE;
    private static final int LIGHT_LEVEL_MAGMA_CUBE_CORE;
    private static final int LIGHT_LEVEL_GLOWSTONE_DUST;
    private static final int LIGHT_LEVEL_PRISMARINE_CRYSTALS;
