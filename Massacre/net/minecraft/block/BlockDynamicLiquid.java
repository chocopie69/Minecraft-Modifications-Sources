...
public class BlockDynamicLiquid extends BlockLiquid {
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      ...
      if (i > 0) {
         ...
         Object enumfacing;
         for(Iterator var9 = EnumFacing.Plane.HORIZONTAL.iterator(); var9.hasNext(); l = this.checkAdjacentBlock(worldIn, pos.offset((EnumFacing)enumfacing), l)) {
            enumfacing = var9.next();
         }
         ...
         do {
            do {
               do {
                  ...
                  enumfacing = var6.next();
               } while(enumfacing == calculateFlowCost);

               blockpos = pos.offset((EnumFacing)enumfacing);
