...
public class NoWebMode extends BooleanOption
{
    public NoWebMode(final String name, final boolean value, final Module module) {
    ...
    public void setValue(final Boolean value) {
        if (value) {
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof NoWebMode) {
            ...
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof NoWebMode && option != this) {
