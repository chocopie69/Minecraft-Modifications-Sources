...
public class GuiScreenBook extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.field_175386_A == null) {
                ...
                for (int k2 = Math.min(128 / 9, this.field_175386_A.size()), l2 = 0; l2 < k2; ++l2) {
                    final IChatComponent ichatcomponent2 = this.field_175386_A.get(l2);
                    this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), (float)(i + 36), (float)(j + 16 + 16 + l2 * 9), 0);
                }
    ...
    public IChatComponent func_175385_b(final int p_175385_1_, final int p_175385_2_) {
        ...
        if (i >= 0 && j >= 0) {
            final int k = Math.min(128 / 9, this.field_175386_A.size());
            if (i <= 116) {
                final int n = j;
