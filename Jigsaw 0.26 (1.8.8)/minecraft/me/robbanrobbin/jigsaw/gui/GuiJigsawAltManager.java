...
public class GuiJigsawAltManager extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		for (Alt alt : Jigsaw.getAltManager().getAlts()) {
			...
			drawString(Fonts.font18, alt.cracked ? "§c" + alt.name : "§c" + alt.name + "§r:" + "§8" + obfPass, left + 6, top + 6, 0xffffffff);
			if (alt.cracked) {
				drawString(Fonts.font18, "§cCracked", right - Fonts.font18.getStringWidth("§cCracked") - 2, bottom - 9, 0xffffffff);
			} else {
				drawString(Fonts.font18, "§bPremium", right - Fonts.font18.getStringWidth("§bPremium") - 2, bottom - 9, 0xffffffff);
			}
			if(selected == alts) {
