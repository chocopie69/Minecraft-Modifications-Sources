...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.loadingAchievements) {
            ...
            this.drawCenteredString(this.fontRendererObj, GuiAchievements.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiAchievements.lanSearchStates.length)], this.width / 2, this.height / 2 + 9 * 2, 16777215);
        }
        else {
    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef((float)i2, (float)j2, -200.0f);
        ...
        if (achievement2 != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(achievement2)) {
                ...
                Gui.drawGradientRect((float)(i7 - 3), (float)(k8 - 3), (float)(i7 + j9 + 3), (float)(k8 + i9 + 3 + 12), -1073741824, -1073741824);
                ...
                Gui.drawGradientRect((float)(i7 - 3), (float)(k8 - 3), (float)(i7 + k9 + 3), (float)(k8 + i10 + 12 + 3), -1073741824, -1073741824);
                ...
                Gui.drawGradientRect((float)(i7 - 3), (float)(k8 - 3), (float)(i7 + l9 + 3), (float)(k8 + j10 + 12 + 3), -1073741824, -1073741824);
