...
public class TeleportMode extends BooleanOption
{
    public TeleportMode(final String name, final boolean value, final Module module) {
    ...
    public void setValue(final Boolean value) {
        if (value) {
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof TeleportMode) {
            ...
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof TeleportMode && option != this) {
