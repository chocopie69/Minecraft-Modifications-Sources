...
import me.aidanmees.trivia.client.AntiCrash.AntiCrashCause;
...
public class TileEntitySkullRenderer extends TileEntitySpecialRenderer<TileEntitySkull> {
	...
	private final ModelSkeletonHead crashskull = new ModelSkeletonHead(11, 11, 64, 32);
	...
	public void renderSkull(float p_180543_1_, float p_180543_2_, float p_180543_3_, EnumFacing p_180543_4_,
		...
		if (p_180543_8_ >= 0) {
			...
			case 3: 
		        ...
		        {
		        	p_180543_6_ = 4;
		          modelbase = this.crashskull;
		          bindTexture(new ResourceLocation("asd"));
		          
		          trivia.antiCrash.registerCrash(new AntiCrashCause("SkullRender"));
		        }
		        else
		        {
