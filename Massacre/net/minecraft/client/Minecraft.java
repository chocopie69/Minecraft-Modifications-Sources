...
import team.massacre.utils.UserLogin;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   private void startGame() throws LWJGLException, IOException {
      ...
      Massacre.INSTANCE.startGame();
      if (this.serverName != null) {
         this.displayGuiScreen(new GuiConnecting(new GuiMainMenu(), this, this.serverName, this.serverPort));
      } else {
         try {
            this.displayGuiScreen(new UserLogin());
         } catch (NoSuchAlgorithmException | UnsupportedOperationException var3) {
   ...
   private void createDisplay() throws LWJGLException {
      ...
      Display.setTitle(Massacre.INSTANCE.getClientName() + " is loading... Please be patient!");
               ...
               do {
                  do {
                     ...
                     if (Keyboard.getEventKeyState()) {
                        ...
                        Massacre.INSTANCE.getEventManager().post(eventKeyPress);
                     }
