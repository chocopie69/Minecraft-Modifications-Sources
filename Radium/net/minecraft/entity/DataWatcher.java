...
public class DataWatcher
{
    ...
    public void updateWatchedObjectsFromList(final List<WatchableObject> watchableObjects) {
        this.lock.writeLock().lock();
        for (final WatchableObject watchableObject : watchableObjects) {
            final int id = watchableObject.getDataValueId();
            final WatchableObject datawatcher$watchableobject1 = this.watchedObjects.get(id);
