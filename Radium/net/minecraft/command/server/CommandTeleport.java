    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (args.length != 1 && args.length != 2) {
            ...
            if (entity.worldObj != null) {
                ...
                CommandBase.notifyOperators(sender, this, "commands.tp.success.coordinates", entity.getCommandSenderName(), commandbase$coordinatearg.func_179628_a(), commandbase$coordinatearg2.func_179628_a(), commandbase$coordinatearg3.func_179628_a());
            }
        }
        else {
            ...
            CommandBase.notifyOperators(sender, this, "commands.tp.success", entity.getCommandSenderName(), entity2.getCommandSenderName());
        }
    }
