...
public class EmptyInputBox extends Gui
{
    ...
    public EmptyInputBox(final int componentId, final FontRenderer fontrendererObj, final int x, final int y, final int par5Width, final int par6Height) {
        this.text = "";
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            final int i = this.isEnabled ? new Color(100, 100, 100).getRGB() : this.disabledColor;
            ...
            if (s.length() > 0) {
                ...
                j2 = FontUtil.moon.drawString(s2, (float)l, (float)i2, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j2 = FontUtil.moon.drawString(s.substring(j), (float)j2, (float)i2, i);
            }
            if (flag2) {
                if (flag3) {
                    ...
                    FontUtil.moon.drawString("_", (float)k2, (float)i2, i);
                }
            }
            if (k != j) {
