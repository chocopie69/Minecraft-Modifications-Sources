    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawSmoothRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1, new Color(0, 105, 173).getRGB());
                RenderUtil.drawSmoothRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, -16777216);
            }
