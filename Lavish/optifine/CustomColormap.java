...
public class CustomColormap implements CustomColors.IColorizer
{
    ...
    private static final int FORMAT_UNKNOWN;
    private static final int FORMAT_VANILLA;
    private static final int FORMAT_GRID;
    private static final int FORMAT_FIXED;
    public static final String FORMAT_VANILLA_STRING;
    public static final String FORMAT_GRID_STRING;
    public static final String FORMAT_FIXED_STRING;
