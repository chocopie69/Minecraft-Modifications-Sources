...
public class Flight extends Module {
	...
	public void onPreMotion(PreMotionEvent event) {
		...
		if(currentMode.equals("Cubecraft")) {
			...
			double moveSpeed = Math.min(4, 0.2873D * Math.pow(((double)(toggleTime) / 10.0), 2.5) + 0.2873D);
	...
	public Component[] getModSettings() {
		...
		return new Component[] { slider1, box2, box1, box3, box4 };
	}
	...
	public void onUpdate(UpdateEvent event) {
		...
		if(currentMode.equals("Cubecraft")) {
			...
			if(!cubecraftEnabled) {
				...
				if(Jigsaw.getModuleByName("TpAura").isToggled()) {
