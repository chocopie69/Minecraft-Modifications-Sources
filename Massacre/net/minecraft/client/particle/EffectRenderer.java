...
public class EffectRenderer {
   ...
   public void updateEffects() {
      ...
      while(var2.hasNext()) {
         Object entityparticleemitter0 = var2.next();
   ...
   private boolean reuseBarrierParticle(EntityFX p_reuseBarrierParticle_1_, List<EntityFX> p_reuseBarrierParticle_2_) {
      ...
      do {
         ...
         entityfx = (EntityFX)var3.next();
      } while(!(entityfx instanceof Barrier) || p_reuseBarrierParticle_1_.posX != entityfx.posX || p_reuseBarrierParticle_1_.posY != entityfx.posY || p_reuseBarrierParticle_1_.posZ != entityfx.posZ);
