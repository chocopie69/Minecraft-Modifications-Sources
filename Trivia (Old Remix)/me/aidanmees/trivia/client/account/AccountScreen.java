...
package me.aidanmees.trivia.client.account;
...
import me.aidanmees.trivia.client.account.component.AltButton;
import me.aidanmees.trivia.client.account.component.Button;
import me.aidanmees.trivia.client.account.screen.Screen;
import me.aidanmees.trivia.client.account.screen.ScreenAddAccount;
import me.aidanmees.trivia.client.account.screen.ScreenEditAccount;
...
public class AccountScreen extends GuiScreen
{
    ...
    public void drawCenteredString(String text, float scale, int xOffset, int yOffset) {
        ...
        while ((float)Minecraft.getMinecraft().fontRendererObj.getStringWidth(text) * scale > (float)this.width) {
        ...
        int strWidth = Minecraft.getMinecraft().fontRendererObj.getStringWidth(text);
...
/*    public void drawAltButtons(final int mouseX, final int mouseY) {
    ...
    private void drawPanorama(final int p_73970_1_, final int p_73970_2_, final float p_73970_3_) {
        ...
        for (int var7 = 0; var7 < var6 * var6; ++var7) {
            ...
            for (int var11 = 0; var11 < 6; ++var11) {
                ...
                var5.pos(-1.0, -1.0, 1.0).tex(0.0f + var12, 0.0f + var12);
                var5.pos(1.0, -1.0, 1.0).tex(1.0f - var12, 0.0f + var12);
                var5.pos(1.0, 1.0, 1.0).tex(1.0f - var12, 1.0f - var12);
                var5.pos(-1.0, 1.0, 1.0).tex(0.0f + var12, 1.0f - var12);
                var4.draw();
    ...
    private void rotateAndBlurSkybox(final float p_73968_1_) {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            var3.setColorRGBA(1, 1, 1, 1 / (var5 + 1));
            final int var6 = this.width;
            final int var7 = this.height;
            final float var8 = (var5 - var4 / 2) / 256.0f;
            var3.pos(var6, var7, this.zLevel).tex(0.0f + var8, 1.0);
            var3.pos(var6, 0.0, this.zLevel).tex( 1.0f + var8, 1.0);
            var3.pos(0.0, 0.0, this.zLevel).tex(1.0f + var8, 0.0);
            var3.pos(0.0, var7, this.zLevel).tex(0.0f + var8, 0.0);
        }
        var2.draw();
    ...
    private void renderSkybox(final int p_73971_1_, final int p_73971_2_, final float p_73971_3_) {
        ...
        var5.setColorRGBA(1, 1, 1, 1);
        final int var9 = this.width;
        final int var10 = this.height;
        var5.pos(0.0, var10, this.zLevel).tex(0.5f - var7, 0.5f + var8);
        var5.pos(var9, var10, this.zLevel).tex(0.5f - var7, 0.5f - var8);
        var5.pos(var9, 0.0, this.zLevel).tex(0.5f + var7, 0.5f - var8);
        var5.pos(0.0, 0.0, this.zLevel).tex( 0.5f + var7, 0.5f + var8);
        var4.draw();
    }
