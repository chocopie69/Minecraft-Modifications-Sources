...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawScaledStringWithShadow(final String p_175063_1_, final double p_175063_2_, final double p_175063_3_, final int p_175063_4_, final double scale) {
        int strWidth = this.getStringWidth(p_175063_1_);
        strWidth *= (int)scale;
        double totalX = p_175063_2_ - strWidth / 2;
        double totalY = p_175063_3_ - this.FONT_HEIGHT * scale / 2.0;
        totalX /= scale;
        totalY /= scale;
        GL11.glPushMatrix();
        GL11.glScaled(scale, scale, 1.0);
        return this.func_175065_a(p_175063_1_, totalX, totalY, p_175063_4_, true);
    }
