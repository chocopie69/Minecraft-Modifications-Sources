...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public static float getPitchHead() {
        return RendererLivingEntity.PitchHead;
    }
    
    public static void setPitchHead(final float perspitch) {
        RendererLivingEntity.PitchHead = perspitch;
    }
    
    public static float getPreviousPitchHead() {
        return RendererLivingEntity.previousPitchHead;
    }
    
    public static void setPreviousPitchHead(final float perspitch) {
        RendererLivingEntity.previousPitchHead = perspitch;
    }
    ...
    public void doRender(final T entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, x, y, z)) {
            ...
            try {
                ...
                if (RenderUtil.SetCustomPitch && entity == Minecraft.getMinecraft().thePlayer) {
                    f5 = RenderUtil.getCustomPitch();
                }
                if (RenderUtil.SetCustomYaw && entity == Minecraft.getMinecraft().thePlayer) {
                    Minecraft.getMinecraft().thePlayer.renderYawOffset = RenderUtil.getCustomYaw();
                    Minecraft.getMinecraft().thePlayer.prevRenderYawOffset = RenderUtil.getCustomYaw();
                }
    ...
    protected void renderModel(final T entitylivingbaseIn, final float p_77036_2_, final float p_77036_3_, final float p_77036_4_, final float p_77036_5_, final float p_77036_6_, final float p_77036_7_) {
        ...
        if (flag || flag2) {
            ...
            final boolean flag3 = ModuleManager.getModule(Chams.class).isEnabled() && entitylivingbaseIn instanceof EntityPlayer;
            if (flag3) {
                final Color chamsColor = Palette.fade(Palette.PURPLE.getColor());
                GL11.glPushMatrix();
                GL11.glEnable(10754);
            ...
            if (flag3) {
                ...
                final Color chamsColor = Palette.PURPLE.getColor();
                GL11.glColor4f(chamsColor.getRed() / 255.0f, chamsColor.getGreen() / 255.0f, chamsColor.getBlue() / 255.0f, chamsColor.getAlpha() / 255.0f);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                GL11.glEnable(3553);
    ...
    protected boolean canRenderName(final T entity) {
        ...
        if (entity instanceof EntityPlayer && entity != entityplayersp) {
            ...
            if (team != null) {
                ...
                switch (RendererLivingEntity1.field_178679_a[team$enumvisible.ordinal()]) {
                    case 1: {
                        return true;
                    }
                    case 2: {
    ...
    static final class RendererLivingEntity1
    {
        ...
        static {
            ...
            try {
                RendererLivingEntity1.field_178679_a[Team.EnumVisible.ALWAYS.ordinal()] = 1;
            }
            catch (NoSuchFieldError noSuchFieldError) {}
            try {
                RendererLivingEntity1.field_178679_a[Team.EnumVisible.NEVER.ordinal()] = 2;
            }
            catch (NoSuchFieldError noSuchFieldError2) {}
            try {
                RendererLivingEntity1.field_178679_a[Team.EnumVisible.HIDE_FOR_OTHER_TEAMS.ordinal()] = 3;
            }
            catch (NoSuchFieldError noSuchFieldError3) {}
            try {
                RendererLivingEntity1.field_178679_a[Team.EnumVisible.HIDE_FOR_OWN_TEAM.ordinal()] = 4;
            }
