...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        EventRender event = new EventRender(scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), scaledresolution);
        ScaledRes.width = scaledresolution.getScaledWidth();
        ScaledRes.height = scaledresolution.getScaledHeight();
        EventManager.onRenderUpdate(event);
    ...
    {
    	EventScoreboard event = new EventScoreboard();
    	EventManager.onEventScoreboard(event);
    	
    	Velo.impl.Modules.visuals.Scoreboard scoreboard2 = new Velo.impl.Modules.visuals.Scoreboard();
    	
    	GlStateManager.pushMatrix();
    	//GlStateManager.translate(-835,0,0);
