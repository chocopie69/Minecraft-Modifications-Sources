...
public class GuiAddAlt extends GuiScreen
{
    ...
    public void drawScreen(final int i2, final int j2, final float f2) {
        ...
        if (this.username.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "Username / E-Mail", (float)(GuiAddAlt.width / 2 - 96), 66.0f, -7829368);
        }
        if (this.password.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "Password", (float)(GuiAddAlt.width / 2 - 96), 106.0f, -7829368);
        }
