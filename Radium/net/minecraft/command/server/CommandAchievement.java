        ...
        if (flag || flag2) {
            if (statbase == null) {
                if (flag) {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.achievement.give.success.all", entityplayermp.getCommandSenderName());
                }
                else if (flag2) {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.achievement.take.success.all", entityplayermp.getCommandSenderName());
                }
            }
            else {
                ...
                if (flag) {
                    ...
                    CommandBase.notifyOperators(sender, this, "commands.achievement.give.success.one", entityplayermp.getCommandSenderName(), statbase.func_150955_j());
                }
                else if (flag2) {
                    entityplayermp.func_175145_a(statbase);
                    CommandBase.notifyOperators(sender, this, "commands.achievement.take.success.one", statbase.func_150955_j(), entityplayermp.getCommandSenderName());
                }
            }
        }
    }
