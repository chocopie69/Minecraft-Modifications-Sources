...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    public void writePlayerData(final EntityPlayer player) {
        try {
            ...
            SaveHandler.logger.warn("Failed to save player data for " + player.getCommandSenderName());
        }
    }
    ...
    public NBTTagCompound readPlayerData(final EntityPlayer player) {
        ...
        try {
            ...
            SaveHandler.logger.warn("Failed to load player data for " + player.getCommandSenderName());
        }
