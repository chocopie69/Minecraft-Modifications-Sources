...
import summer.cheat.cheats.render.ChestESP;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest> {
    ...
    public void renderTileEntityAt(TileEntityChest te, double x, double y, double z, float partialTicks,
        ...
        if (te.adjacentChestZNeg == null && te.adjacentChestXNeg == null) {
            ...
            boolean doOutline = (CheatManager.getInstance(ChestESP.class).isToggled()
                    && ChestESP.chestType.getValString().equalsIgnoreCase("Outline"));
            ...
            if (doOutline && te.hasWorldObj()) {
                ...
                RenderUtils.renderFour(new Color(ChestESP.colorRed.getValFloat() / 255F,
                        ChestESP.colorGreen.getValFloat() / 255F,
                        ChestESP.colorBlue.getValFloat() / 255F).getRGB());
                modelchest.renderAll();
