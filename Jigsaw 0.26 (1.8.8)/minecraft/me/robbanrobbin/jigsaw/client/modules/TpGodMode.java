...
public class TpGodMode extends Module {
	...
	public void onUpdate(UpdateEvent event) {
		if(mc.thePlayer.onGround) {
			if(tped) {
				Utils.blinkToPosFromPos(new Vec3(mc.thePlayer.posX, mc.thePlayer.posY + 400, mc.thePlayer.posZ), new Vec3(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ), 9.9);
			}
			Utils.blinkToPosFromPos(new Vec3(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ), new Vec3(mc.thePlayer.posX, mc.thePlayer.posY + 400, mc.thePlayer.posZ), 9.9);
			tped = true;
			event.cancel();
		}
		else {
