...
public class CommandEffect extends CommandBase
{
    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (args[1].equals("clear")) {
            ...
            CommandBase.notifyOperators(sender, this, "commands.effect.success.removed.all", entitylivingbase.getCommandSenderName());
        }
        else {
            int i;
            try {
            ...
            if (l > 0) {
                ...
                CommandBase.notifyOperators(sender, this, "commands.effect.success", new ChatComponentTranslation(potioneffect.getEffectName(), new Object[0]), i, k, entitylivingbase.getCommandSenderName(), l);
            }
            else {
                if (!entitylivingbase.isPotionActive(i)) {
                    throw new CommandException("commands.effect.failure.notActive", new Object[] { new ChatComponentTranslation(potion2.getName(), new Object[0]), entitylivingbase.getCommandSenderName() });
                }
                entitylivingbase.removePotionEffect(i);
                CommandBase.notifyOperators(sender, this, "commands.effect.success.removed", new ChatComponentTranslation(potion2.getName(), new Object[0]), entitylivingbase.getCommandSenderName());
            }
        }
    }
