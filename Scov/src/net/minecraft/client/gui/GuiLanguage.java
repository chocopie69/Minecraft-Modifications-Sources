...
public class GuiLanguage extends GuiScreen
{
    ...
    class List extends GuiSlot
    {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            ...
            GuiLanguage.this.fontRendererObj.setUnicodeFlag(GuiLanguage.this.languageManager.isCurrentLanguageBidirectional());
        ...
        {
            GuiLanguage.this.fontRendererObj.setUnicodeFlag(true);
            ...
            GuiLanguage.this.fontRendererObj.setUnicodeFlag(GuiLanguage.this.languageManager.getCurrentLanguage().isBidirectional());
        }
    }
}
