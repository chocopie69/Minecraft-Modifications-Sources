...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            final GuiIngestServers this$0 = GuiIngestServers.this;
            Gui.drawString(GuiIngestServers.this.fontRendererObj, ingestserver.serverName, p_180791_2_ + 2, p_180791_3_ + 5, 16777215);
            final GuiIngestServers this$2 = GuiIngestServers.this;
            Gui.drawString(GuiIngestServers.this.fontRendererObj, s, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT + 5 + 3, 3158064);
            final GuiIngestServers this$3 = GuiIngestServers.this;
            Gui.drawString(GuiIngestServers.this.fontRendererObj, s2, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s2), p_180791_3_ + 5, 8421504);
            if (s3 != null) {
                final GuiIngestServers this$4 = GuiIngestServers.this;
                Gui.drawString(GuiIngestServers.this.fontRendererObj, s3, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s3), p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
            }
        }
