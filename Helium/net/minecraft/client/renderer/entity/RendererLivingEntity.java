...
import rip.helium.cheat.impl.visual.Chams;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            if (entity == Minecraft.getMinecraft().thePlayer && (Helium.instance.cheatManager.isCheatEnabled("KillAura") || Helium.instance.cheatManager.isCheatEnabled("Scaffold"))) {
            ...
            if (this.renderOutlines) {
                ...
                if (valid) {
                    boolean shouldFill = Helium.instance.cheatManager.isCheatEnabled("Chams") && Chams.fill.getValue();
                    if (shouldFill) {
        ...
        Helium.instance.eventBus.publish(ePost);
    }
    ...
    public void renderName(T entity, double x, double y, double z) {
        ...
        Helium.eventBus.publish(renderNametagEvent);
