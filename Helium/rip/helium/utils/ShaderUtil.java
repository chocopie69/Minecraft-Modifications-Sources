...
public class ShaderUtil {
    ...
    public void draw() {
        ...
        GL20.glUniform2f(GL20.glGetUniformLocation(program, "resolution"), (float) ScaledResolution.getScaledWidth(), (float) ScaledResolution.getScaledHeight()); //So setzt man ne uniform
