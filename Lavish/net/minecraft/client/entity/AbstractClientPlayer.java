...
public abstract class AbstractClientPlayer extends EntityPlayer
{
    ...
    public float getFovModifier() {
        ...
        if (Client.instance.moduleManager.getModuleByName("Scaffold").isEnabled() && Minecraft.getMinecraft().thePlayer.moveForward > 0.0f && Client.instance.setmgr.getSettingByName("Sprint").getValBoolean() && Scaffold.lastBlockCache != null && Client.instance.setmgr.getSettingByName("Scaffold Rotation").getValString().equalsIgnoreCase("Hypixel")) {
            f *= (float)((iattributeinstance.getAttributeValue() / this.capabilities.getWalkSpeed() + 1.0) / 2.0 + 0.15);
        }
        else {
