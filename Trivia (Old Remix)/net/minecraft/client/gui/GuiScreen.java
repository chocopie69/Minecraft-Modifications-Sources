...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
	...
	public int ticks = 0;
	private static String ChestStealerIsOn = "Toggle ChestStealer";
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.id == 1234512345 && this.getUsePanicButton()) {
			for (Module m : trivia.getModuleGroupMananger().getModuleGroupByName("AuraGroup").getModules()) {
				m.setToggled(false, !m.getName().equalsIgnoreCase("MobArena"));
			}
		}
		if (button.id == 0) {
			if (trivia.getModuleByName("ChestStealer").isToggled()) {
			trivia.getModuleByName("ChestStealer").setToggled(false, false);
			
			
			}
			else {
				trivia.getModuleByName("ChestStealer").setToggled(true, true);
	...
	public void setWorldAndResolution(Minecraft mc, int width, int height) {
		...
		if(!(this instanceof UIRenderer)) {
			trivia.getUIRenderer().setWorldAndResolution(mc, width, height);
		}
	}
	...
	public void initGui() {
		ticks = 0;
		if (this.getUsePanicButton()) {
			
			
			
			this.buttonList.add(new GuiButton(0, 0, +20, 111, 20, ChestStealerIsOn));
			this.buttonList.add(new GuiButton(1234512345, 0, 0, 111, 20, "Disable all aura's"));
		}
...
//		// TODO trivia invmove
//		if (trivia.getModuleByName("InvMove").isToggled() && this instanceof GuiContainer) {
//			return;
//		}
	...
	protected void actionPerformed(GuiButtonDark button) throws IOException {
		if (button.id == 1234512345 && this.getUsePanicButton() ) {
