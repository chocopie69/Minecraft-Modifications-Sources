...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener, IPlayerUsage
{
    ...
    public void updateTimeLightAndEntities() {
        ...
        for (final ITickable iTickable : this.playersOnline) {
            iTickable.update();
        }
    }
    ...
    public CrashReport addServerInfoToCrashReport(final CrashReport report) {
        if (this.serverConfigManager != null) {
            report.getCategory().addCrashSectionCallable("Player Count", () -> String.valueOf(this.serverConfigManager.getCurrentPlayerCount()) + " / " + this.serverConfigManager.getMaxPlayers() + "; " + this.serverConfigManager.func_181057_v());
        }
        return report;
    }
