    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = Minecraft.getMinecraft().fontRendererObj.drawString(this.text.replaceAll("(?s).", "*"), (int)var7, (float)var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                Minecraft.getMinecraft().fontRendererObj.drawString(var4.substring(var2), (int)var9, (float)var8, var1);
            }
            if (var6) {
                if (var10) {
                    ...
                    Minecraft.getMinecraft().fontRendererObj.drawString("_", (int)var11, (float)var8, var1);
                }
            }
            if (var3 != var2) {
