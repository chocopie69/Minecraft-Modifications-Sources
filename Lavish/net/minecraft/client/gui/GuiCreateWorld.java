...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.field_146344_y) {
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.enterSeed", new Object[0]), (float)(GuiCreateWorld.width / 2 - 100), 47.0f, -6250336);
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.seedInfo", new Object[0]), (float)(GuiCreateWorld.width / 2 - 100), 85.0f, -6250336);
            if (this.btnMapFeatures.visible) {
                this.drawString(this.fontRendererObj, I18n.format("selectWorld.mapFeatures.info", new Object[0]), (float)(GuiCreateWorld.width / 2 - 150), 122.0f, -6250336);
            }
            if (this.btnAllowCommands.visible) {
                this.drawString(this.fontRendererObj, I18n.format("selectWorld.allowCommands.info", new Object[0]), (float)(GuiCreateWorld.width / 2 - 150), 172.0f, -6250336);
            }
            ...
            this.drawString(this.fontRendererObj, I18n.format("selectWorld.enterName", new Object[0]), (float)(GuiCreateWorld.width / 2 - 100), 47.0f, -6250336);
            this.drawString(this.fontRendererObj, String.valueOf(I18n.format("selectWorld.resultFolder", new Object[0])) + " " + this.field_146336_i, (float)(GuiCreateWorld.width / 2 - 100), 85.0f, -6250336);
            this.field_146333_g.drawTextBox();
            this.drawString(this.fontRendererObj, this.field_146323_G, (float)(GuiCreateWorld.width / 2 - 100), 137.0f, -6250336);
            this.drawString(this.fontRendererObj, this.field_146328_H, (float)(GuiCreateWorld.width / 2 - 100), 149.0f, -6250336);
        }
