...
public class Vec3d {
    ...
    public net.minecraft.util.Vec3d mc() {
        return new net.minecraft.util.Vec3d(xCoord, yCoord, zCoord);
    }
    ...
    public Vec3d normalize() {
        ...
        return var1 < 1.0E-4D ? new Vec3d(0.0D, 0.0D, 0.0D)
                : new Vec3d(this.xCoord / var1, this.yCoord / var1, this.zCoord / var1);
    }
    ...
    public Vec3d getIntermediateWithXValue(Vec3d vec, double x) {
        ...
        return (var10 >= 0.0D) && (var10 <= 1.0D)
                ? new Vec3d(this.xCoord + var4 * var10, this.yCoord + var6 * var10, this.zCoord + var8 * var10)
                : null;
    }
