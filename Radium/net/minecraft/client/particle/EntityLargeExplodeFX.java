...
public class EntityLargeExplodeFX extends EntityFX
{
    ...
    public void renderParticle(final WorldRenderer worldRendererIn, final Entity entityIn, final float partialTicks, final float p_180434_4_, final float p_180434_5_, final float p_180434_6_, final float p_180434_7_, final float p_180434_8_) {
        ...
        if (i <= 15) {
            ...
            worldRendererIn.pos(f6 - p_180434_4_ * f5 - p_180434_7_ * f5, f7 - p_180434_5_ * f5, f8 - p_180434_6_ * f5 - p_180434_8_ * f5).tex(f2, f4).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
            worldRendererIn.pos(f6 - p_180434_4_ * f5 + p_180434_7_ * f5, f7 + p_180434_5_ * f5, f8 - p_180434_6_ * f5 + p_180434_8_ * f5).tex(f2, f3).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
            worldRendererIn.pos(f6 + p_180434_4_ * f5 + p_180434_7_ * f5, f7 + p_180434_5_ * f5, f8 + p_180434_6_ * f5 + p_180434_8_ * f5).tex(f, f3).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
            worldRendererIn.pos(f6 + p_180434_4_ * f5 - p_180434_7_ * f5, f7 - p_180434_5_ * f5, f8 + p_180434_6_ * f5 - p_180434_8_ * f5).tex(f, f4).color4f(this.particleRed, this.particleGreen, this.particleBlue, 1.0f).func_181671_a(0, 240).func_181663_c(0.0f, 1.0f, 0.0f).endVertex();
