...
import slavikcodd3r.rainbow.module.modules.render.ItemPhysics;
import slavikcodd3r.rainbow.module.modules.render.NoRender;
import slavikcodd3r.rainbow.utils.ItemUtil;
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
      if (!new NoRender().getInstance().isEnabled()) {
    	  if (new ItemPhysics().getInstance().isEnabled()) {
    		  ItemUtil.doRenderItemPhysic((EntityItem)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    	  } else {
