...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        GlStateManager.enableAlpha();
        final EventRenderGUI e = new EventRenderGUI(scaledresolution);
        Client.instance.onEvent(e);
    }
    ...
    protected void renderTooltip(final ScaledResolution sr, final float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            this.zLevel = -90.0f;
            this.drawTexturedModalRect(i - 91, sr.getScaledHeight() - 22 - HUD.ylevel, 0, 0, 182, 22);
            this.drawTexturedModalRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1 - HUD.ylevel, 0, 22, 24, 22);
            this.zLevel = f;
            ...
            for (int j = 0; j < 9; ++j) {
                ...
                this.renderHotbarItem(j, k, l - HUD.ylevel, partialTicks, entityplayer);
            }
    ...
    public void renderExpBar(final ScaledResolution p_175176_1_, final int p_175176_2_) {
        ...
        if (i > 0) {
            ...
            this.drawTexturedModalRect(p_175176_2_, j - HUD.ylevel, 0, 64, short1, 5);
            if (k > 0) {
                this.drawTexturedModalRect(p_175176_2_, j - HUD.ylevel, 0, 69, k, 5);
            }
        }
        this.mc.mcProfiler.endSection();
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            this.getFontRenderer().drawString(s, i2 + 1, l - HUD.ylevel, 0);
            this.getFontRenderer().drawString(s, i2 - 1, l - HUD.ylevel, 0);
            this.getFontRenderer().drawString(s, i2, l + 1 - HUD.ylevel, 0);
            this.getFontRenderer().drawString(s, i2, l - 1 - HUD.ylevel, 0);
            this.getFontRenderer().drawString(s, i2, l - HUD.ylevel, j2);
            this.mc.mcProfiler.endSection();
        }
    }
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            for (int i4 = 0; i4 < 10; ++i4) {
                if (k3 > 0) {
                    ...
                    if (i4 * 2 + 1 < k3) {
                        this.drawTexturedModalRect(j4, j3 - HUD.ylevel, 34, 9, 9, 9);
                    }
                    if (i4 * 2 + 1 == k3) {
                        this.drawTexturedModalRect(j4, j3 - HUD.ylevel, 25, 9, 9, 9);
                    }
                    if (i4 * 2 + 1 > k3) {
                        this.drawTexturedModalRect(j4, j3 - HUD.ylevel, 16, 9, 9, 9);
                    }
                }
            }
            ...
            for (int j5 = MathHelper.ceiling_float_int((f + f2) / 2.0f) - 1; j5 >= 0; --j5) {
                ...
                this.drawTexturedModalRect(l4, i5 - HUD.ylevel, 16 + b0 * 9, 9 * b2, 9, 9);
                if (flag) {
                    if (j5 * 2 + 1 < j) {
                        this.drawTexturedModalRect(l4, i5 - HUD.ylevel, k4 + 54, 9 * b2, 9, 9);
                    }
                    if (j5 * 2 + 1 == j) {
                        this.drawTexturedModalRect(l4, i5 - HUD.ylevel, k4 + 63, 9 * b2, 9, 9);
                    }
                }
                if (f3 <= 0.0f) {
                    if (j5 * 2 + 1 < i) {
                        this.drawTexturedModalRect(l4, i5 - HUD.ylevel, k4 + 36, 9 * b2, 9, 9);
                    }
                    if (j5 * 2 + 1 == i) {
                        this.drawTexturedModalRect(l4, i5 - HUD.ylevel, k4 + 45, 9 * b2, 9, 9);
                    }
                }
                else {
                    if (f3 == f2 && f2 % 2.0f == 1.0f) {
                        this.drawTexturedModalRect(l4, i5 - HUD.ylevel, k4 + 153, 9 * b2, 9, 9);
                    }
                    else {
                        this.drawTexturedModalRect(l4, i5 - HUD.ylevel, k4 + 144, 9 * b2, 9, 9);
                    }
                    f3 -= 2.0f;
                }
            }
            ...
            if (entity == null) {
                ...
                for (int l5 = 0; l5 < 10; ++l5) {
                    ...
                    this.drawTexturedModalRect(k6, i6 - HUD.ylevel, 16 + b3 * 9, 27, 9, 9);
                    if (flag2) {
                        if (l5 * 2 + 1 < l) {
                            this.drawTexturedModalRect(k6, i6 - HUD.ylevel, j6 + 54, 27, 9, 9);
                        }
                        if (l5 * 2 + 1 == l) {
                            this.drawTexturedModalRect(k6, i6 - HUD.ylevel, j6 + 63, 27, 9, 9);
                        }
                    }
                    if (l5 * 2 + 1 < k) {
                        this.drawTexturedModalRect(k6, i6 - HUD.ylevel, j6 + 36, 27, 9, 9);
                    }
                    if (l5 * 2 + 1 == k) {
                        this.drawTexturedModalRect(k6, i6 - HUD.ylevel, j6 + 45, 27, 9, 9);
                    }
                }
            }
                ...
                while (l7 > 0) {
                    ...
                    for (int l8 = 0; l8 < k7; ++l8) {
                        ...
                        this.drawTexturedModalRect(i7, j7 - HUD.ylevel, b4 + b5 * 9, 9, 9, 9);
                        if (l8 * 2 + 1 + j8 < l6) {
                            this.drawTexturedModalRect(i7, j7 - HUD.ylevel, b4 + 36, 9, 9, 9);
                        }
                        if (l8 * 2 + 1 + j8 == l6) {
                            this.drawTexturedModalRect(i7, j7 - HUD.ylevel, b4 + 45, 9, 9, 9);
                        }
                    }
                    j7 -= 10;
                    j8 += 20;
