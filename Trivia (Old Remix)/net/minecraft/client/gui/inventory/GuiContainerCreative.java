...
public class GuiContainerCreative extends InventoryEffectRenderer {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int n = arrcreativeTabs.length;
        int n2 = 0;
        while (n2 < n) {
            CreativeTabs creativetabs = arrcreativeTabs[n2];
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int n2 = 0;
        while (n2 < n) {
            CreativeTabs creativetabs1 = arrcreativeTabs[n2];
        ...
        if (creativetabs == CreativeTabs.tabInventory) {
            GuiInventory.drawEntityOnScreen(this.guiLeft + 43, this.guiTop + 45, 20, this.guiLeft + 43 - mouseX, this.guiTop + 45 - 30 - mouseY, mc.thePlayer);
        }
    }
	...
	protected boolean func_147049_a(CreativeTabs p_147049_1_, int p_147049_2_, int p_147049_3_) {
        ...
        if (p_147049_2_ >= j && p_147049_2_ <= j + 28 && p_147049_3_ >= k && p_147049_3_ <= k + 32) {
            return true;
        }
        return false;
    }
