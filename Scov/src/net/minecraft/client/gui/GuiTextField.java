...
public class GuiTextField extends Gui
{
    ...
    private final VanillaFontRenderer fontRendererInstance;
    ...
    public GuiTextField(int componentId, VanillaFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
