...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        final EventUpdate e = new EventUpdate(this.rotationYaw, this.rotationPitch, this.onGround, this.posY, this.posX, this.posZ, true);
    ...
    public void onUpdateWalkingPlayer() {
        final EventMotion event = new EventMotion(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
        ...
        if (this.isCurrentViewEntity()) {
            final double d0 = event.getX() - this.lastReportedPosX;
            final double d2 = event.getY() - this.lastReportedPosY;
            final double d3 = event.getZ() - this.lastReportedPosZ;
            final double d4 = event.getYaw() - this.lastReportedYaw;
            final double d5 = event.getPitch() - this.lastReportedPitch;
        ...
        if (message.startsWith(".")) {
            if (CommandManager.isCommand(message)) {
                ...
                if (cmd.getExecutor() != null) {
                    ...
                    Console.sendChatToPlayerWithPrefix(EnumChatFormatting.RED + "A" + EnumChatFormatting.BOLD + " FATAL" + EnumChatFormatting.RESET + EnumChatFormatting.RED + "error has occurred!");
                }
            }
            else {
                Console.sendChatToPlayerWithPrefix(EnumChatFormatting.RED + "Unknown Command!");
            }
        }
        else {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            if (Client.instance.moduleManager.getModuleByName("NoSlow").isEnabled() && Client.instance.setmgr.getSettingByName("NoSlow Mode").getValString().equalsIgnoreCase("Vanilla")) {
                this.setSprinting(true);
            }
            if (Client.instance.moduleManager.getModuleByName("NoSlow").isEnabled() && Client.instance.setmgr.getSettingByName("NoSlow Mode").getValString().equalsIgnoreCase("NCP")) {
                this.setSprinting(true);
            }
            if (!Client.instance.moduleManager.getModuleByName("NoSlow").isEnabled()) {
