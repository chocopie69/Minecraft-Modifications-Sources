...
public class EntityFootStepFX extends EntityFX
{
    ...
    public void renderParticle(final WorldRenderer worldRendererIn, final Entity entityIn, final float partialTicks, final float p_180434_4_, final float p_180434_5_, final float p_180434_6_, final float p_180434_7_, final float p_180434_8_) {
        ...
        worldRendererIn.pos(f4 - 0.125f, f5, f6 + 0.125f).tex(0.0, 1.0).color4f(f7, f7, f7, f2).endVertex();
        worldRendererIn.pos(f4 + 0.125f, f5, f6 + 0.125f).tex(1.0, 1.0).color4f(f7, f7, f7, f2).endVertex();
        worldRendererIn.pos(f4 + 0.125f, f5, f6 - 0.125f).tex(1.0, 0.0).color4f(f7, f7, f7, f2).endVertex();
        worldRendererIn.pos(f4 - 0.125f, f5, f6 - 0.125f).tex(0.0, 0.0).color4f(f7, f7, f7, f2).endVertex();
