...
public class HighJumpMode extends BooleanOption
{
    public HighJumpMode(final String name, final boolean value, final Module module) {
    ...
    public void setValue(final Boolean value) {
        if (value) {
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof HighJumpMode) {
            ...
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof HighJumpMode && option != this) {
