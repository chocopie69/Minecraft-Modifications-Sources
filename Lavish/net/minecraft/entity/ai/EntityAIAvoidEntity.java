...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase
{
    ...
    public EntityAIAvoidEntity(final EntityCreature p_i46404_1_, final Class<T> p_i46404_2_, final float p_i46404_3_, final double p_i46404_4_, final double p_i46404_6_) {
        this(p_i46404_1_, (Class)p_i46404_2_, Predicates.alwaysTrue(), p_i46404_3_, p_i46404_4_, p_i46404_6_);
    }
    ...
    public boolean shouldExecute() {
        final List<T> list = this.theEntity.worldObj.getEntitiesWithinAABB((Class<? extends T>)this.field_181064_i, this.theEntity.getEntityBoundingBox().expand(this.avoidDistance, 3.0, this.avoidDistance), (com.google.common.base.Predicate<? super T>)Predicates.and(new Predicate[] { EntitySelectors.NOT_SPECTATING, this.canBeSeenSelector, this.avoidTargetSelector }));
        if (list.isEmpty()) {
            return false;
        }
