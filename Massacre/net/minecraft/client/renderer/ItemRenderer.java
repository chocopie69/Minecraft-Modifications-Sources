...
public class ItemRenderer {
   ...
   public void renderItemInFirstPerson(float partialTicks) {
      ...
      if (this.itemToRender != null) {
         if (this.itemToRender.getItem() instanceof ItemMap) {
         ...
         } else if (entityplayersp.getItemInUseCount() > 0 || killaura.block && killaura.getState()) {
            ...
            case DRINK:
               ...
               break;
            case BLOCK:
               Animations animations = (Animations)Massacre.INSTANCE.getModuleManager().getModule(Animations.class);
               switch((Animations.AnimationsMode)animations.mode.getValue()) {
               case ONEPOINTSEVEN:
