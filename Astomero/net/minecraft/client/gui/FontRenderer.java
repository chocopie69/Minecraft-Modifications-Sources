...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawStringWithShadow1(final String text, final double scale, final double x, final double y, final int color) {
    ...
    public void drawTotalCenteredStringWithShadow(final String text, final double x, final double y, final int color) {
        this.drawStringWithShadow(text, x - this.getStringWidth(text) / 2, y - this.FONT_HEIGHT / 2.0f, color);
    }
    ...
    private void renderStringAtPos(String p_78255_1_, final boolean p_78255_2_) {
        if (Astomero.instance.moduleManager.getModuleByName("NameProtect").isEnabled() && Minecraft.getMinecraft().thePlayer != null && p_78255_1_.contains(Minecraft.getMinecraft().thePlayer.getName())) {
