...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, GuiStats.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiStats.lanSearchStates.length)], this.width / 2, this.height / 2 + 9 * 2, 16777215);
        }
        else {
            ...
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
                ...
                if (i >= 0) {
                    ...
                    if (s.length() > 0) {
                        ...
                        Gui.drawGradientRect((float)(k - 3), (float)(l - 3), (float)(k + i2 + 3), (float)(l + 8 + 3), -1073741824, -1073741824);
        ...
        protected void func_148213_a(final StatCrafting p_148213_1_, final int p_148213_2_, final int p_148213_3_) {
            if (p_148213_1_ != null) {
                ...
                if (s2.length() > 0) {
                    ...
                    Gui.drawGradientRect((float)(i - 3), (float)(j - 3), (float)(i + k + 3), (float)(j + 8 + 3), -1073741824, -1073741824);
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + 9, (i == 0) ? 6316128 : 9474192);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s3, p_180791_2_ + 2, p_180791_3_ + 1 + 9 * 2, (j == 0) ? 6316128 : 9474192);
        }
    }
}
