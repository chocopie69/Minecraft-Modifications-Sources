...
public final class SpdyHttpHeaders
{
    ...
    public static final class Names
    {
        ...
        public static final String ASSOCIATED_TO_STREAM_ID;
        ...
        static {
            STREAM_ID = "X-SPDY-Stream-ID";
            SCHEME = "X-SPDY-Scheme";
            URL = "X-SPDY-URL";
            PRIORITY = "X-SPDY-Priority";
            ASSOCIATED_TO_STREAM_ID = "X-SPDY-Associated-To-Stream-ID";
        }
    }
}
