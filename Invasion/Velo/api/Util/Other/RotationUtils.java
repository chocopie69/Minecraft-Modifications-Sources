...
public class RotationUtils {
	...
	public static void rotate(final EventPreMotion event, final float[] rotations, final float aimSpeed, final boolean lockView) {
		final float[] prevRotations = {event.getYaw(), event.getPitch()};
