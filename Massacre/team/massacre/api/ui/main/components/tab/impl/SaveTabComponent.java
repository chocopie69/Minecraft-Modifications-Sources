...
public final class SaveTabComponent extends TabComponent {
   public SaveTabComponent(Component parent, float x, float y, float width, float height) {
      super(parent, Tab.SAVE, x, y, width, height);
   }
}
