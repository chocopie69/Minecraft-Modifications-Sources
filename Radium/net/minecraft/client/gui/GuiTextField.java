...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(final int componentId, final MinecraftFontRenderer fontrendererObj, final String placeholder, final int x, final int y, final int par5Width, final int par6Height) {
        this.text = "";
    ...
    public GuiTextField(final int componentId, final MinecraftFontRenderer fontrendererObj, final int x, final int y, final int par5Width, final int par6Height) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                this.fontRendererInstance.drawStringWithShadow("§7" + this.placeholder, (float)l, (float)i2, -1);
            }
            ...
            if (flag2) {
                if (flag3) {
                    Gui.drawRect((float)k2, (float)(i2 - 1), (float)(k2 + 1), (float)(i2 + 1 + 9), -3092272);
                }
                else {
            ...
            if (k != j) {
                ...
                this.drawCursorVertical(k2, i2 - 1, l2 - 1, i2 + 1 + 9);
            }
        }
    }
