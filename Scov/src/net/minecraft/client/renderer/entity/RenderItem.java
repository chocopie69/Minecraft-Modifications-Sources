...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemOverlays(VanillaFontRenderer fr, ItemStack stack, int xPosition, int yPosition)
    {
     ...
     */
    public void renderItemOverlayIntoGUI(VanillaFontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        if (stack != null)
        {
