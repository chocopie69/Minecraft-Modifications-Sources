...
public class GuiIngame extends Gui
{
    ...
    {
    	if (new slavikcodd3r.rainbow.module.modules.render.Scoreboard().getInstance().isEnabled()) {
    	if (!slavikcodd3r.rainbow.module.modules.render.Scoreboard.noscoreboard) {
        ...
        double var23 = p_180475_2_.getScaledHeight() / slavikcodd3r.rainbow.module.modules.render.Scoreboard.customy + var22 / 3;
        byte var24 = 3;
        ...
        while (var12.hasNext())
        {
            ...
            double var18 = var23 - var11 * this.func_175179_f().FONT_HEIGHT;
            ...
            int var22 = var21.size() * this.func_175179_f().FONT_HEIGHT;
            double var23 = p_180475_2_.getScaledHeight() / 2 + var22 / 3;
            byte var24 = 3;
            int var25 = p_180475_2_.getScaledWidth() - var6 - var24;
            int var11 = 0;
            Iterator var12 = var21.iterator();
