...
public class UtilityForAuthentication {

    public static boolean check() {
        int lines = 0;
        try {
            URL url = new URL("http://cheesemanprot.000webhostapp.com/uiashduf8u9yhsd98fhas98dfyu89asdhjf89uashdfuiasd/" + HWID.getHWID());
