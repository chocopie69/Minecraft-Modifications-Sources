...
public class GuiPlayerTabOverlay extends Gui
{
        ...
        for (int k3 = 0; k3 < l3; ++k3) {
            ...
            if (k3 < list.size()) {
                ...
                if (flag) {
                    ...
                    Gui.drawScaledCustomSizeModalRect(j4, k4, 8.0f, (float)l6, 8.0, i6, 8.0, 8.0, 64.0f, 64.0f);
                    if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                        final int j5 = 8 + (flag2 ? 8 : 0);
                        final int k5 = 8 * (flag2 ? -1 : 1);
                        Gui.drawScaledCustomSizeModalRect(j4, k4, 40.0f, (float)j5, 8.0, k5, 8.0, 8.0, 64.0f, 64.0f);
                    }
                    j4 += 9;
                }
    ...
    public List getPlayerList() {
        final NetHandlerPlayClient var4 = this.mc.getNetHandler();
        return GuiPlayerTabOverlay.field_175252_a.sortedCopy((Iterable)var4.getPlayerInfoMap());
    }
