...
public class FontRenderer {
    ...
    private FontUtils regularGlyphPage, boldGlyphPage, italicGlyphPage, boldItalicGlyphPage;

    public FontRenderer(FontUtils regularGlyphPage, FontUtils boldGlyphPage, FontUtils italicGlyphPage, FontUtils boldItalicGlyphPage) {
    ...
    public static FontRenderer create(String fontName, int size, boolean bold, boolean italic, boolean boldItalic) {
        ...
        FontUtils regularPage;

        regularPage = new FontUtils(new Font(fontName, Font.PLAIN, size), true, true);

        regularPage.generateGlyphPage(chars);
        regularPage.setupTexture();

        FontUtils boldPage = regularPage;
        FontUtils italicPage = regularPage;
        FontUtils boldItalicPage = regularPage;

        if (bold) {
            boldPage = new FontUtils(new Font(fontName, Font.BOLD, size), true, true);
        ...
        if (italic) {
            italicPage = new FontUtils(new Font(fontName, Font.ITALIC, size), true, true);
        ...
        if (boldItalic) {
            boldItalicPage = new FontUtils(new Font(fontName, Font.BOLD | Font.ITALIC, size), true, true);
    ...
    private void renderStringAtPos(String text, boolean shadow) {
    	FontUtils glyphPage = getCurrentGlyphPage();
    ...
    private void doDraw(float f, FontUtils glyphPage) {
    ...
    private FontUtils getCurrentGlyphPage() {
