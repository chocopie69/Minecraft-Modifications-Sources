...
public class ModelHorse extends ModelBase
{
    ...
    public void render(final Entity entityIn, final float p_78088_2_, final float p_78088_3_, final float p_78088_4_, final float p_78088_5_, final float p_78088_6_, final float scale) {
        ...
        if (!flag) {
            GL11.glPushMatrix();
            GL11.glScalef(f2, 0.5f + f2 * 0.5f, f2);
            GL11.glTranslatef(0.0f, 0.95f * (1.0f - f2), 0.0f);
        }
        ...
        if (!flag) {
            ...
            GL11.glTranslatef(0.0f, 1.35f * (1.0f - f2), 0.0f);
        }
        ...
        if (!flag) {
            ...
            if (f <= 0.0f) {
                ...
                GL11.glTranslatef(0.0f, 0.9f * (1.0f - f2) * f + 1.35f * (1.0f - f2) * (1.0f - f), 0.15f * (1.0f - f2) * f);
            }
        }
        if (flag4) {
