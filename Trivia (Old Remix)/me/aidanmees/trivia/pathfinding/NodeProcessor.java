package me.aidanmees.trivia.pathfinding;
...
public class NodeProcessor {
	...
	public void getPath(BlockPos start, BlockPos finish) {
		...
		while(openNodes.size() > 0) {
			...
			trivia.chatMessage(openNodes.size());
	...
	public Node createNode(BlockPos pos) {
		return new Node(Utils.getBlock(pos).getMaterial() == Material.air &&  Utils.getBlock(pos.up()).getMaterial() == Material.air&&  Utils.getBlock(pos.up()).getMaterial() == Material.air, pos);
	}
