...
public class Slider extends Component {
	...
	public void draw() {
		...
		GL11.glColor4f(0.07f, 0.07f, 0.07f, 0.8f - trivia.getClickGuiManager().getAlpha());
		...
		glEnd();
		GL11.glColor4f(0.1f, 0.1f, 0.1f, 0.8f - trivia.getClickGuiManager().getAlpha());
		glBegin(GL11.GL_LINES);
		{
		...
		GL11.glColor4f(1f, 1f, 1f, 1f - trivia.getClickGuiManager().getAlpha());
		glBegin(GL11.GL_QUADS);
		{
		...
		if(trivia.getClickGuiManager().getAlpha() <= 0.5f) {
			fontRenderer.drawString(title, 1, -1, 
					0xffffffff);
			String sValue = getValueString();
			fontRenderer.drawString(sValue, (int) (getWidth() - fontRenderer.getStringWidth(sValue) - 2), -1, 
					0xffffffff);
		}
