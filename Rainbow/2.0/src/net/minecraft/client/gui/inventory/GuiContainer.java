...
public abstract class GuiContainer extends GuiScreen
{
    ...
    {
        this.buttonList.add(new GuiButton(1337, 2, 3, 110, 20, "Disable KillAura"));
        this.buttonList.add(new GuiButton(1338, 2, 24, 110, 20, "Disable AutoArmor"));
        this.buttonList.add(new GuiButton(1339, 2, 45, 110, 20, "Disable InvCleaner"));
        this.buttonList.add(new GuiButton(1340, 2, 66, 110, 20, "Disable ChestStealer"));
    }
    ...
    {
        if (button.id == 1337) {
        	if (ModuleManager.getModule("KillAura").getInstance().isEnabled()) {
        		ModuleManager.getModule("KillAura").getInstance().disable();
        	}
        }
        if (button.id == 1338) {
        	if (ModuleManager.getModule("AutoArmor").getInstance().isEnabled()) {
        		ModuleManager.getModule("AutoArmor").getInstance().disable();
        	}
        }
        if (button.id == 1339) {
        	if (ModuleManager.getModule("InvCleaner").getInstance().isEnabled()) {
        		ModuleManager.getModule("InvCleaner").getInstance().disable();
        	}
        }
        if (button.id == 1340) {
        	if (ModuleManager.getModule("ChestStealer").getInstance().isEnabled()) {
        		ModuleManager.getModule("ChestStealer").getInstance().disable();
        	}
        }
    }
