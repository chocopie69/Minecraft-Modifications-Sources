...
public class KillAura extends Module {
	...
	public Component[] getModSettings() {
		...
		// Killaura lock
		// final CheckButton killauraLockCB = new BasicCheckButton("Lockview");
		// killauraLockCB.setSelected(ClientSettings.KillauraHeadsnap);
		// killauraLockCB.addButtonListener(new ButtonListener() {
		//
		// @Override
		// public void onButtonPress(Button button) {
		// ClientSettings.KillauraHeadsnap = killauraLockCB.isSelected();
		// }
		//
		// @Override
		...
		return new Component[] { killaruarangeslider, killaruaspeedslider };
	}
