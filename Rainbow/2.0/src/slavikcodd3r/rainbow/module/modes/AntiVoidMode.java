...
public class AntiVoidMode extends BooleanOption
{
    public AntiVoidMode(final String name, final boolean value, final Module module) {
    ...
    public void setValue(final Boolean value) {
        if (value) {
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof AntiVoidMode) {
            ...
            for (final Option option : OptionManager.getOptionList()) {
                if (option.getModule().equals(this.getModule()) && option instanceof AntiVoidMode && option != this) {
