...
@Module.Mod(displayName = "StaffDetector")
...
{   
    ...
    public void onPacket(final PacketReceiveEvent event) {
        if (event.getPacket() instanceof S02PacketChat) {
            ...
            for (final String str : staff) {
                if (packet.getChatComponent().getUnformattedText().contains(str)) {
                	if (!this.quit) {
                		mc.thePlayer.isDead = true;
                		ClientUtils.sendMessage("You were frozen because staff was found, write .antifreeze to defrost yourself");
                	} else {
                    	ClientUtils.sendMessage("You automatically logged out of the server because staff was found");
