...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(final float partialTicks) {
        ...
        if (this.itemToRender != null) {
            final Module killAura = Astomero.instance.moduleManager.getMod("KillAura");
            ModeSet blockMode = null;
            for (final Setting s : Astomero.instance.moduleManager.getMod("KillAura").getSettings()) {
                if (s.name.equalsIgnoreCase("AutoBlock")) {
                    blockMode = (ModeSet)s;
                }
            }
            final boolean isKillAuraAttacking = KillAura.closestTarget != null;
