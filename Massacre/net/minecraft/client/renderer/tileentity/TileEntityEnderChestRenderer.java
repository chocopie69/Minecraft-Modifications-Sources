...
public class TileEntityEnderChestRenderer extends TileEntitySpecialRenderer<TileEntityEnderChest> {
   ...
   public void renderTileEntityAt(TileEntityEnderChest te, double x, double y, double z, float partialTicks, int destroyStage) {
      ...
      ChestESP instance = ChestESP.getInstance();
      if (instance.getState() && instance.isChams()) {
         boolean visibleFlat = (Boolean)instance.visibleFlatProperty.getValue();
         boolean occludedFlat = (Boolean)instance.occludedFlatProperty.getValue();
         int visibleColor = (Integer)instance.visibleColorProperty.getValue();
         int occludedColor = (Integer)instance.occludedColorProperty.getValue();
