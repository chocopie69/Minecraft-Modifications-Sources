...
public abstract class GuiSlot
{
    ...
    public void drawScreen(final int mouseXIn, final int mouseYIn, final float p_148128_3_) {
        if (this.field_178041_q) {
            ...
            worldrenderer.pos(this.left, this.top + i2, 0.0).tex(0.0, 1.0).color4i(0, 0, 0, 0).endVertex();
            worldrenderer.pos(this.right, this.top + i2, 0.0).tex(1.0, 1.0).color4i(0, 0, 0, 0).endVertex();
            ...
            worldrenderer.pos(this.right, this.bottom - i2, 0.0).tex(1.0, 0.0).color4i(0, 0, 0, 0).endVertex();
            worldrenderer.pos(this.left, this.bottom - i2, 0.0).tex(0.0, 0.0).color4i(0, 0, 0, 0).endVertex();
            tessellator.draw();
            ...
            if (j2 > 0) {
                ...
                tessellator.draw();
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                worldrenderer.pos(i, l2 + k2, 0.0).tex(0.0, 1.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(j, l2 + k2, 0.0).tex(1.0, 1.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(j, l2, 0.0).tex(1.0, 0.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(i, l2, 0.0).tex(0.0, 0.0).color4i(128, 128, 128, 255).endVertex();
                tessellator.draw();
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                worldrenderer.pos(i, l2 + k2 - 1, 0.0).tex(0.0, 1.0).color4i(192, 192, 192, 255).endVertex();
                worldrenderer.pos(j - 1, l2 + k2 - 1, 0.0).tex(1.0, 1.0).color4i(192, 192, 192, 255).endVertex();
                worldrenderer.pos(j - 1, l2, 0.0).tex(1.0, 0.0).color4i(192, 192, 192, 255).endVertex();
                worldrenderer.pos(i, l2, 0.0).tex(0.0, 0.0).color4i(192, 192, 192, 255).endVertex();
                tessellator.draw();
            }
    ...
    protected void drawSelectionBox(final int p_148120_1_, final int p_148120_2_, final int mouseXIn, final int mouseYIn) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (this.showSelectionBox && this.isSelected(j)) {
                ...
                GlStateManager.disableTexture2D();
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                worldrenderer.pos(i2, k + l + 2, 0.0).tex(0.0, 1.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(j2, k + l + 2, 0.0).tex(1.0, 1.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(j2, k - 2, 0.0).tex(1.0, 0.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(i2, k - 2, 0.0).tex(0.0, 0.0).color4i(128, 128, 128, 255).endVertex();
                worldrenderer.pos(i2 + 1, k + l + 1, 0.0).tex(0.0, 1.0).color4i(0, 0, 0, 255).endVertex();
                worldrenderer.pos(j2 - 1, k + l + 1, 0.0).tex(1.0, 1.0).color4i(0, 0, 0, 255).endVertex();
                worldrenderer.pos(j2 - 1, k - 1, 0.0).tex(1.0, 0.0).color4i(0, 0, 0, 255).endVertex();
                worldrenderer.pos(i2 + 1, k - 1, 0.0).tex(0.0, 0.0).color4i(0, 0, 0, 255).endVertex();
                tessellator.draw();
                GlStateManager.enableTexture2D();
            }
    ...
    protected void overlayBackground(final int startY, final int endY, final int startAlpha, final int endAlpha) {
        ...
        final float f = 32.0f;
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        worldrenderer.pos(this.left, endY, 0.0).tex(0.0, endY / 32.0f).color4i(64, 64, 64, endAlpha).endVertex();
        worldrenderer.pos(this.left + this.width, endY, 0.0).tex(this.width / 32.0f, endY / 32.0f).color4i(64, 64, 64, endAlpha).endVertex();
        worldrenderer.pos(this.left + this.width, startY, 0.0).tex(this.width / 32.0f, startY / 32.0f).color4i(64, 64, 64, startAlpha).endVertex();
        worldrenderer.pos(this.left, startY, 0.0).tex(0.0, startY / 32.0f).color4i(64, 64, 64, startAlpha).endVertex();
        tessellator.draw();
    }
    ...
    protected void drawContainerBackground(final Tessellator p_drawContainerBackground_1_) {
        ...
        final float f = 32.0f;
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        worldrenderer.pos(this.left, this.bottom, 0.0).tex(this.left / f, (this.bottom + (int)this.amountScrolled) / f).color4i(32, 32, 32, 255).endVertex();
        worldrenderer.pos(this.right, this.bottom, 0.0).tex(this.right / f, (this.bottom + (int)this.amountScrolled) / f).color4i(32, 32, 32, 255).endVertex();
        worldrenderer.pos(this.right, this.top, 0.0).tex(this.right / f, (this.top + (int)this.amountScrolled) / f).color4i(32, 32, 32, 255).endVertex();
        worldrenderer.pos(this.left, this.top, 0.0).tex(this.left / f, (this.top + (int)this.amountScrolled) / f).color4i(32, 32, 32, 255).endVertex();
