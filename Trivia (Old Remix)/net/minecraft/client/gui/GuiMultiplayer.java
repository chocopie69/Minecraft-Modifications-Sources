...
import me.aidanmees.trivia.gui.GuitriviaUseProxy;
import net.mcleaks.ChatColor;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.CustomButton.CustomCheckbox;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
	...
	public void createButtons() {
		 ...
		 this.buttonList.add(this.btnSelectServer = new GuiButton(1, this.width / 2 - 154 - 5 - 4, this.height - 52, 80, 20, I18n.format("selectServer.select", new Object[0])));
		    this.buttonList.add(new GuiButton(4, this.width / 2 - 74 - 5 - 2, this.height - 52, 80, 20, I18n.format("selectServer.direct", new Object[0])));
		    this.buttonList.add(new GuiButton(3, this.width / 2 + 4 - 5 + 2 , this.height - 52, 80, 20, I18n.format("selectServer.add", new Object[0])));
		    this.buttonList.add(new GuiButton(5, this.width / 2 + 4 + 76 + 5 -2, this.height - 52, 80, 20, ChatColor.RED + "Set nick/UUID"));
		    
		    this.buttonList.add(this.btnEditServer = new GuiButton(7, this.width / 2 - 154 - 5 - 4, this.height - 28, 80, 20, I18n.format("selectServer.edit", new Object[0])));
		    this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2 - 74 - 5 - 2, this.height - 28, 80, 20, I18n.format("selectServer.delete", new Object[0])));
		    this.buttonList.add(new GuiButton(8, this.width / 2 + 4 - 5 + 2 , this.height - 28, 80 , 20, I18n.format("selectServer.refresh", new Object[0])));
		    this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76 + 5 -2, this.height - 28, 80, 20, I18n.format("gui.cancel", new Object[0])));
		    this.buttonList.add(new GuiButton(69, this.width - 85, this.height / 50, 80, 20, "Direct login"));
		    this.buttonList.add(new GuiButton(70, this.width -85 - 85, this.height / 50, 80, 20, "Alt-Checker"));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.enabled) {
		    ...
		    } else if (button.id == 1014) {
            bungeehack = ((CustomCheckbox)button).isChecked();
            
        }
		    else if (button.id == 100)
		      {
		    	
		        trivia.protocol = !trivia.protocol;
		        System.out.println(trivia.protocol);
		      }
		else if (button.id == 5)
	      {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, String.valueOf(trivia.protocol), 95, 24, 16777215);
