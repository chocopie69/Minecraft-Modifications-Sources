...
public class MathHelper
{
    ...
    public static float sin(final float p_76126_0_) {
        return MathHelper.SIN_TABLE_FAST[(int)(p_76126_0_ * MathHelper.radToIndex) & 0xFFF];
    }
    
    public static float cos(final float value) {
        return MathHelper.SIN_TABLE_FAST[(int)(value * MathHelper.radToIndex + 1024.0f) & 0xFFF];
    }
