...
public class GuiJigsawCredits extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, "Coder - Robofån", 25 / 2, 25 / 2, 0xffffffff);
		...
		this.drawString(fontRendererObj, "§cHerrKanelBulle§r - NewNCP speed", 30,
				245, 0xffffffff);
		this.drawString(fontRendererObj, "§8xDark§r - ToTheDumpster ServerCrasher mode", 30,
				255, 0xffffffff);
