...
public abstract class EntityLivingBase extends Entity
{
    ...
    public boolean attackEntityFrom(final DamageSource source, float amount) {
        ...
        boolean flag = true;
        if (this.hurtResistantTime > 20.0f / 2.0f) {
    ...
    private int getArmSwingAnimationEnd() {
        final int speed = (int)(6.0f * (Animations.getInstance().isEnabled() ? Animations.getInstance().swingSpeed.getValue().floatValue() : 1.0f));
    ...
    protected void collideWithNearbyEntities() {
        final List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224), (Predicate<? super Entity>)Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, Entity::canBePushed));
        if (!list.isEmpty()) {
