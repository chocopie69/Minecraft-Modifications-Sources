...
final class SpdyCodecUtil
{
    ...
    static {
        SPDY_HEADER_TYPE_OFFSET = 2;
        SPDY_HEADER_SIZE = 8;
        SPDY_MAX_LENGTH = 16777215;
        SPDY_SESSION_STREAM_ID = 0;
        SPDY_PUSH_PROMISE_FRAME = 5;
        SPDY_HEADER_FLAGS_OFFSET = 4;
        SPDY_GOAWAY_FRAME = 7;
        SPDY_PING_FRAME = 6;
        SPDY_SETTINGS_CLEAR = 1;
        SPDY_SETTINGS_PERSISTED = 2;
        SPDY_DATA_FRAME = 0;
        SPDY_FLAG_UNIDIRECTIONAL = 2;
        SPDY_HEADER_LENGTH_OFFSET = 5;
        SPDY_SYN_REPLY_FRAME = 2;
        SPDY_RST_STREAM_FRAME = 3;
        SPDY_FLAG_FIN = 1;
        SPDY_MAX_NV_LENGTH = 65535;
        SPDY_SETTINGS_MAX_ID = 16777215;
        SPDY_SYN_STREAM_FRAME = 1;
        SPDY_SETTINGS_FRAME = 4;
        SPDY_SETTINGS_PERSIST_VALUE = 1;
        SPDY_DATA_FLAG_FIN = 1;
        SPDY_WINDOW_UPDATE_FRAME = 9;
        SPDY_HEADERS_FRAME = 8;
