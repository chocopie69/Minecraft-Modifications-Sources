...
public class Gui
{
     ...
     */
    public static void drawRect(double left, double var18, double right, double d, int color)
    {
        double var5;
        ...
        var10.addVertex((double)right, (double)var18, 0.0D);
        var10.addVertex((double)left, (double)var18, 0.0D);
        var9.draw();
