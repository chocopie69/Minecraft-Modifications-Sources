...
public class MapData extends WorldSavedData
{
    ...
    public Map<String, Vec4b> playersVisibleOnMap;
    ...
    public MapData(final String mapname) {
        ...
        this.playersVisibleOnMap = (Map<String, Vec4b>)Maps.newLinkedHashMap();
    }
        ...
        for (int i = 0; i < this.playersArrayList.size(); ++i) {
            ...
            if (!mapdata$mapinfo2.entityplayerObj.isDead && (mapdata$mapinfo2.entityplayerObj.inventory.hasItemStack(mapStack) || mapStack.isOnItemFrame())) {
                if (!mapStack.isOnItemFrame() && mapdata$mapinfo2.entityplayerObj.dimension == this.dimension) {
                    this.updatePlayersVisibleOnMap(0, mapdata$mapinfo2.entityplayerObj.worldObj, mapdata$mapinfo2.entityplayerObj.getCommandSenderName(), mapdata$mapinfo2.entityplayerObj.posX, mapdata$mapinfo2.entityplayerObj.posZ, mapdata$mapinfo2.entityplayerObj.rotationYaw);
                }
            }
            else {
    ...
    private void updatePlayersVisibleOnMap(int type, final World worldIn, final String entityIdentifier, final double worldX, final double worldZ, double rotation) {
        ...
        this.playersVisibleOnMap.put(entityIdentifier, new Vec4b((byte)type, b0, b2, b3));
    }
