...
public class HueSlider extends Component {
	...
	public HueSlider(NumberSetting set, int x, int y) {
		this.set = set;
		this.x = x;
		this.y = y;
	}
	...
	public void renderComponent() {
		...
		RenderUtil.draw2DImage(new ResourceLocation("client/hue.png"), x ,  y + 10, 91, 8, Color.WHITE);
	//	RenderUtil.instance.draw2DImage(new ResourceLocation("client/hue.png"), x + 49 ,  y + 10, 42, 8, Color.WHITE);
		...
		//Gui.drawRect(x, y + 10, x + 2, y + 10 + 12, 0x80000000);
		 ...
		 Fonts.targethud.drawString(this.set.getName() + ": " + (int) this.set.getValue() , x, y, -1);
