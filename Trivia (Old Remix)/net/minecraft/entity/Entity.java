...
public abstract class Entity implements ICommandSender {
	...
	public Entity(World worldIn) {
		...
		enuid = MathHelper.getRandomUuid(this.rand);
	...
	// TODO trivia entity setPosition
	/**
	 * Sets the x,y,z of the entity from the given parameters. Also seems to set
	 * up a bounding box.
	 */
	...
	public void moveEntity(double x, double y, double z) {
		if (this.noClip) {
			...
			double d4 = y;
			double d5 = z;
			//TODO trivia SafeWalk
			boolean flag = this.onGround && (this.isSneaking() || trivia.getModuleByName("SafeWalk").isToggled() ||
					(((trivia.getModuleByName("Scaffold").isToggled()) ))) && this instanceof EntityPlayer;
			...
			if(trivia.getModuleByName("SafeWalk").isToggled()) {
				flag = false;
			}
	...
	public void readFromNBT(NBTTagCompound tagCompund) {
		try {
			...
			if (tagCompund.hasKey("UUIDMost", 4) && tagCompund.hasKey("UUIDLeast", 4)) {
				...
				enuid = UUID.fromString(tagCompund.getString("UUID"));
			}
