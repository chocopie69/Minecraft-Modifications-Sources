...
public class WorldRenderer {
	...
	public void func_178991_c(int p_178991_1_)
	  {
		int i = this.getColorIndex(p_178991_1_);
	    int var2 = p_178991_1_ >> 16 & 0xFF;
	    int var3 = p_178991_1_ >> 8 & 0xFF;
	    int var4 = p_178991_1_ & 0xFF;
	    int i1 = p_178991_1_ >> 24 & 255;
	    this.putColorRGBA(1 , var2, var3, var4 , i1);
	  }
    ...
    public void setColorRGBA(int p_178961_1_, int p_178961_2_, int p_178961_3_, int p_178961_4_)
    {
        if (!this.needsUpdate)
        {
            ...
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN)
            {
                this.drawMode = p_178961_4_ << 24 | p_178961_3_ << 16 | p_178961_2_ << 8 | p_178961_1_;
            }
            else
            {
            	this.drawMode = p_178961_1_ << 24 | p_178961_2_ << 16 | p_178961_3_ << 8 | p_178961_4_;
            }
        }
    }

	public void addVertexWithUV(double d, double e, double f, float g, float h) {
