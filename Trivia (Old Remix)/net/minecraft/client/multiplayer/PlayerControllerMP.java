...
public class PlayerControllerMP {
	...
	public float getBlockReachDistance() {
		if (trivia.getModuleByName("Reach").isToggled()) { //TODO: extended reach
			return (float) ClientSettings.Reach;
		}
		if (trivia.getModuleByName("ClickTeleport").isToggled()) { //TODO: extended reach
			return (float) 30;
		}
	...
	public boolean extendedReach() {
		if (trivia.getModuleByName("Reach").isToggled()) {
			return true;
		}
		return this.currentGameType.isCreative();
	}
